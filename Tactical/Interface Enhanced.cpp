...
void InitEDBCoords(OBJECTTYPE * pObject)
{
	...
	if(gGameExternalOptions.fNewAttachmentSystem){
		...
		{
			// Icon Locations
			gMiscItemStatsEDB[0].sX = SHIFT_X + 47;	gMiscItemStatsEDB[0].sY = SHIFT_Y + 124;	gMiscItemStatsEDB[0].sValDx = 0;	// COL 1; ROW 1
			gMiscItemStatsEDB[1].sX = SHIFT_X + 47;	gMiscItemStatsEDB[1].sY = SHIFT_Y + 136;	gMiscItemStatsEDB[1].sValDx = 0;	// COL 1; ROW 2
			gMiscItemStatsEDB[2].sX = SHIFT_X + 47;	gMiscItemStatsEDB[2].sY = SHIFT_Y + 148;	gMiscItemStatsEDB[2].sValDx = 0;	// COL 1; ROW 3
			gMiscItemStatsEDB[3].sX = SHIFT_X + 47;	gMiscItemStatsEDB[3].sY = SHIFT_Y + 160;	gMiscItemStatsEDB[3].sValDx = 0;	// COL 1; ROW 4
			gMiscItemStatsEDB[4].sX = SHIFT_X + 47;	gMiscItemStatsEDB[4].sY = SHIFT_Y + 172;	gMiscItemStatsEDB[4].sValDx = 0;	// COL 1; ROW 5
			gMiscItemStatsEDB[5].sX = SHIFT_X + 47;	gMiscItemStatsEDB[5].sY = SHIFT_Y + 184;	gMiscItemStatsEDB[5].sValDx = 0;	// COL 1; ROW 6
			gMiscItemStatsEDB[6].sX = SHIFT_X + 47;	gMiscItemStatsEDB[6].sY = SHIFT_Y + 196;	gMiscItemStatsEDB[6].sValDx = 0;	// COL 1; ROW 7
			gMiscItemStatsEDB[7].sX = SHIFT_X + 144;	gMiscItemStatsEDB[7].sY = SHIFT_Y + 124;	gMiscItemStatsEDB[7].sValDx = 0;	// COL 2; ROW 1
			gMiscItemStatsEDB[8].sX = SHIFT_X + 144;	gMiscItemStatsEDB[8].sY = SHIFT_Y + 136;	gMiscItemStatsEDB[8].sValDx = 0;	// COL 2; ROW 2
			gMiscItemStatsEDB[9].sX = SHIFT_X + 144;	gMiscItemStatsEDB[9].sY = SHIFT_Y + 148;	gMiscItemStatsEDB[9].sValDx = 0;	// COL 2; ROW 3
			gMiscItemStatsEDB[10].sX = SHIFT_X + 144;	gMiscItemStatsEDB[10].sY = SHIFT_Y + 160;	gMiscItemStatsEDB[10].sValDx = 0;	// COL 2; ROW 4
			gMiscItemStatsEDB[11].sX = SHIFT_X + 144;	gMiscItemStatsEDB[11].sY = SHIFT_Y + 172;	gMiscItemStatsEDB[11].sValDx = 0;	// COL 2; ROW 5
			gMiscItemStatsEDB[12].sX = SHIFT_X + 144;	gMiscItemStatsEDB[12].sY = SHIFT_Y + 184;	gMiscItemStatsEDB[12].sValDx = 0;	// COL 2; ROW 6
			gMiscItemStatsEDB[13].sX = SHIFT_X + 144;	gMiscItemStatsEDB[13].sY = SHIFT_Y + 196;	gMiscItemStatsEDB[13].sValDx = 0;	// COL 2; ROW 7
			// EQUALS signs Locations
			gMiscItemStatsEDB[14].sX = SHIFT_X + 97;	gMiscItemStatsEDB[14].sY = SHIFT_Y + 124;	gMiscItemStatsEDB[14].sValDx = 12;	// COL 1; ROW 1
			gMiscItemStatsEDB[15].sX = SHIFT_X + 97;	gMiscItemStatsEDB[15].sY = SHIFT_Y + 136;	gMiscItemStatsEDB[15].sValDx = 12;	// COL 1; ROW 2
			gMiscItemStatsEDB[16].sX = SHIFT_X + 97;	gMiscItemStatsEDB[16].sY = SHIFT_Y + 148;	gMiscItemStatsEDB[16].sValDx = 12;	// COL 1; ROW 3
			gMiscItemStatsEDB[17].sX = SHIFT_X + 97;	gMiscItemStatsEDB[17].sY = SHIFT_Y + 160;	gMiscItemStatsEDB[17].sValDx = 12;	// COL 1; ROW 4
			gMiscItemStatsEDB[18].sX = SHIFT_X + 97;	gMiscItemStatsEDB[18].sY = SHIFT_Y + 172;	gMiscItemStatsEDB[18].sValDx = 12;	// COL 1; ROW 5
			gMiscItemStatsEDB[19].sX = SHIFT_X + 97;	gMiscItemStatsEDB[19].sY = SHIFT_Y + 184;	gMiscItemStatsEDB[19].sValDx = 12;	// COL 1; ROW 6
			gMiscItemStatsEDB[20].sX = SHIFT_X + 97;	gMiscItemStatsEDB[20].sY = SHIFT_Y + 196;	gMiscItemStatsEDB[20].sValDx = 12;	// COL 1; ROW 7
			gMiscItemStatsEDB[21].sX = SHIFT_X + 194;	gMiscItemStatsEDB[21].sY = SHIFT_Y + 124;	gMiscItemStatsEDB[21].sValDx = 12;	// COL 2; ROW 1
			gMiscItemStatsEDB[22].sX = SHIFT_X + 194;	gMiscItemStatsEDB[22].sY = SHIFT_Y + 136;	gMiscItemStatsEDB[22].sValDx = 12;	// COL 2; ROW 2
			gMiscItemStatsEDB[23].sX = SHIFT_X + 194;	gMiscItemStatsEDB[23].sY = SHIFT_Y + 148;	gMiscItemStatsEDB[23].sValDx = 12;	// COL 2; ROW 3
			gMiscItemStatsEDB[24].sX = SHIFT_X + 194;	gMiscItemStatsEDB[24].sY = SHIFT_Y + 160;	gMiscItemStatsEDB[24].sValDx = 12;	// COL 2; ROW 4
			gMiscItemStatsEDB[25].sX = SHIFT_X + 194;	gMiscItemStatsEDB[25].sY = SHIFT_Y + 172;	gMiscItemStatsEDB[25].sValDx = 12;	// COL 2; ROW 5
			gMiscItemStatsEDB[26].sX = SHIFT_X + 194;	gMiscItemStatsEDB[26].sY = SHIFT_Y + 184;	gMiscItemStatsEDB[26].sValDx = 12;	// COL 2; ROW 6
			gMiscItemStatsEDB[27].sX = SHIFT_X + 194;	gMiscItemStatsEDB[27].sY = SHIFT_Y + 196;	gMiscItemStatsEDB[27].sValDx = 12;	// COL 2; ROW 7

			gWeaponDescStatsRects[0].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[0].iTop = SHIFT_Y + 229;	gWeaponDescStatsRects[0].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[0].iBottom = SHIFT_Y + 240; // First Column
			gWeaponDescStatsRects[1].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[1].iTop = SHIFT_Y + 241;	gWeaponDescStatsRects[1].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[1].iBottom = SHIFT_Y + 252;
			gWeaponDescStatsRects[2].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[2].iTop = SHIFT_Y + 253;	gWeaponDescStatsRects[2].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[2].iBottom = SHIFT_Y + 264;
			gWeaponDescStatsRects[3].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[3].iTop = SHIFT_Y + 265;	gWeaponDescStatsRects[3].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[3].iBottom = SHIFT_Y + 276;
			gWeaponDescStatsRects[4].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[4].iTop = SHIFT_Y + 277;	gWeaponDescStatsRects[4].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[4].iBottom = SHIFT_Y + 288;
			gWeaponDescStatsRects[5].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[5].iTop = SHIFT_Y + 289;	gWeaponDescStatsRects[5].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[5].iBottom = SHIFT_Y + 300;
			gWeaponDescStatsRects[6].iLeft = SHIFT_X + 46;	gWeaponDescStatsRects[6].iTop = SHIFT_Y + 301;	gWeaponDescStatsRects[6].iRight = SHIFT_X + 103;	gWeaponDescStatsRects[6].iBottom = SHIFT_Y + 312;
			gWeaponDescStatsRects[7].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[7].iTop = SHIFT_Y + 241;	gWeaponDescStatsRects[7].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[7].iBottom = SHIFT_Y + 252; // Second Column
			gWeaponDescStatsRects[8].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[8].iTop = SHIFT_Y + 253;	gWeaponDescStatsRects[8].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[8].iBottom = SHIFT_Y + 264;
			gWeaponDescStatsRects[9].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[9].iTop = SHIFT_Y + 265;	gWeaponDescStatsRects[9].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[9].iBottom = SHIFT_Y + 276;
			gWeaponDescStatsRects[10].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[10].iTop = SHIFT_Y + 277;	gWeaponDescStatsRects[10].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[10].iBottom = SHIFT_Y + 288;
			gWeaponDescStatsRects[11].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[11].iTop = SHIFT_Y + 289;	gWeaponDescStatsRects[11].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[11].iBottom = SHIFT_Y + 300;
			gWeaponDescStatsRects[12].iLeft = SHIFT_X + 111;	gWeaponDescStatsRects[12].iTop = SHIFT_Y + 301;	gWeaponDescStatsRects[12].iRight = SHIFT_X + 168;	gWeaponDescStatsRects[12].iBottom = SHIFT_Y + 312;
			gWeaponDescStatsRects[13].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[13].iTop = SHIFT_Y + 229;	gWeaponDescStatsRects[13].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[13].iBottom = SHIFT_Y + 240; // Third Column
			gWeaponDescStatsRects[14].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[14].iTop = SHIFT_Y + 241;	gWeaponDescStatsRects[14].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[14].iBottom = SHIFT_Y + 252;
			gWeaponDescStatsRects[15].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[15].iTop = SHIFT_Y + 253;	gWeaponDescStatsRects[15].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[15].iBottom = SHIFT_Y + 264;
			gWeaponDescStatsRects[16].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[16].iTop = SHIFT_Y + 265;	gWeaponDescStatsRects[16].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[16].iBottom = SHIFT_Y + 276;
			gWeaponDescStatsRects[17].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[17].iTop = SHIFT_Y + 277;	gWeaponDescStatsRects[17].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[17].iBottom = SHIFT_Y + 288;
			gWeaponDescStatsRects[18].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[18].iTop = SHIFT_Y + 289;	gWeaponDescStatsRects[18].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[18].iBottom = SHIFT_Y + 300;
			gWeaponDescStatsRects[19].iLeft = SHIFT_X + 173;	gWeaponDescStatsRects[19].iTop = SHIFT_Y + 301;	gWeaponDescStatsRects[19].iRight = SHIFT_X + 230;	gWeaponDescStatsRects[19].iBottom = SHIFT_Y + 312;

			gAmmoDescStatsRects[0].iLeft = SHIFT_X + 46;		gAmmoDescStatsRects[0].iTop = SHIFT_Y + 229;	gAmmoDescStatsRects[0].iRight = SHIFT_X + 103;	gAmmoDescStatsRects[0].iBottom = SHIFT_Y + 240;	// First Column
			gAmmoDescStatsRects[1].iLeft = SHIFT_X + 46;		gAmmoDescStatsRects[1].iTop = SHIFT_Y + 241;	gAmmoDescStatsRects[1].iRight = SHIFT_X + 103;	gAmmoDescStatsRects[1].iBottom = SHIFT_Y + 252;
			gAmmoDescStatsRects[2].iLeft = SHIFT_X + 46;		gAmmoDescStatsRects[2].iTop = SHIFT_Y + 253;	gAmmoDescStatsRects[2].iRight = SHIFT_X + 103;	gAmmoDescStatsRects[2].iBottom = SHIFT_Y + 264;
			gAmmoDescStatsRects[3].iLeft = SHIFT_X + 113;		gAmmoDescStatsRects[3].iTop = SHIFT_Y + 229;	gAmmoDescStatsRects[3].iRight = SHIFT_X + 135;	gAmmoDescStatsRects[3].iBottom = SHIFT_Y + 252;	// Second Column
			gAmmoDescStatsRects[4].iLeft = SHIFT_X + 140;		gAmmoDescStatsRects[4].iTop = SHIFT_Y + 229;	gAmmoDescStatsRects[4].iRight = SHIFT_X + 165;	gAmmoDescStatsRects[4].iBottom = SHIFT_Y + 252;
			gAmmoDescStatsRects[5].iLeft = SHIFT_X + 113;		gAmmoDescStatsRects[5].iTop = SHIFT_Y + 253;	gAmmoDescStatsRects[5].iRight = SHIFT_X + 135;	gAmmoDescStatsRects[5].iBottom = SHIFT_Y + 276;
			gAmmoDescStatsRects[6].iLeft = SHIFT_X + 140;		gAmmoDescStatsRects[6].iTop = SHIFT_Y + 253;	gAmmoDescStatsRects[6].iRight = SHIFT_X + 165;	gAmmoDescStatsRects[6].iBottom = SHIFT_Y + 276;
			gAmmoDescStatsRects[7].iLeft = SHIFT_X + 113;		gAmmoDescStatsRects[7].iTop = SHIFT_Y + 277;	gAmmoDescStatsRects[7].iRight = SHIFT_X + 135;	gAmmoDescStatsRects[7].iBottom = SHIFT_Y + 300;
			gAmmoDescStatsRects[8].iLeft = SHIFT_X + 173;		gAmmoDescStatsRects[8].iTop = SHIFT_Y + 229;	gAmmoDescStatsRects[8].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[8].iBottom = SHIFT_Y + 240;	// Third Column
			gAmmoDescStatsRects[9].iLeft = SHIFT_X + 173;		gAmmoDescStatsRects[9].iTop = SHIFT_Y + 241;	gAmmoDescStatsRects[9].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[9].iBottom = SHIFT_Y + 252;
			gAmmoDescStatsRects[10].iLeft = SHIFT_X + 173;	gAmmoDescStatsRects[10].iTop = SHIFT_Y + 253;	gAmmoDescStatsRects[10].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[10].iBottom = SHIFT_Y + 264;
			gAmmoDescStatsRects[11].iLeft = SHIFT_X + 173;	gAmmoDescStatsRects[11].iTop = SHIFT_Y + 265;	gAmmoDescStatsRects[11].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[11].iBottom = SHIFT_Y + 276;
			gAmmoDescStatsRects[12].iLeft = SHIFT_X + 173;	gAmmoDescStatsRects[12].iTop = SHIFT_Y + 277;	gAmmoDescStatsRects[12].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[12].iBottom = SHIFT_Y + 288;	// Fourth Column
			gAmmoDescStatsRects[13].iLeft = SHIFT_X + 173;	gAmmoDescStatsRects[13].iTop = SHIFT_Y + 289;	gAmmoDescStatsRects[13].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[13].iBottom = SHIFT_Y + 300;
			gAmmoDescStatsRects[14].iLeft = SHIFT_X + 173;	gAmmoDescStatsRects[14].iTop = SHIFT_Y + 301;	gAmmoDescStatsRects[14].iRight = SHIFT_X + 230;	gAmmoDescStatsRects[14].iBottom = SHIFT_Y + 312;	// Placeholders
			gAmmoDescStatsRects[15].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[15].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[15].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[15].iBottom = SHIFT_Y + 1;
			gAmmoDescStatsRects[16].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[16].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[16].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[16].iBottom = SHIFT_Y + 1;
			gAmmoDescStatsRects[17].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[17].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[17].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[17].iBottom = SHIFT_Y + 1;
			gAmmoDescStatsRects[18].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[18].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[18].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[18].iBottom = SHIFT_Y + 1;
			gAmmoDescStatsRects[19].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[19].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[19].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[19].iBottom = SHIFT_Y + 1;

			gArmorDescStatsRects[0].iLeft = SHIFT_X + 46;		gArmorDescStatsRects[0].iTop = SHIFT_Y + 229;		gArmorDescStatsRects[0].iRight = SHIFT_X + 103;	gArmorDescStatsRects[0].iBottom = SHIFT_Y + 240;    // First Column
			gArmorDescStatsRects[1].iLeft = SHIFT_X + 46;		gArmorDescStatsRects[1].iTop = SHIFT_Y + 241;		gArmorDescStatsRects[1].iRight = SHIFT_X + 103;	gArmorDescStatsRects[1].iBottom = SHIFT_Y + 252;
			gArmorDescStatsRects[2].iLeft = SHIFT_X + 46;		gArmorDescStatsRects[2].iTop = SHIFT_Y + 253;		gArmorDescStatsRects[2].iRight = SHIFT_X + 103;	gArmorDescStatsRects[2].iBottom = SHIFT_Y + 264;
			gArmorDescStatsRects[3].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[3].iTop = SHIFT_Y + 229;		gArmorDescStatsRects[3].iRight = SHIFT_X + 168;	gArmorDescStatsRects[3].iBottom = SHIFT_Y + 240;    // Second Column
			gArmorDescStatsRects[4].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[4].iTop = SHIFT_Y + 241;		gArmorDescStatsRects[4].iRight = SHIFT_X + 168;	gArmorDescStatsRects[4].iBottom = SHIFT_Y + 252;
			gArmorDescStatsRects[5].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[5].iTop = SHIFT_Y + 253;		gArmorDescStatsRects[5].iRight = SHIFT_X + 168;	gArmorDescStatsRects[5].iBottom = SHIFT_Y + 264;
			gArmorDescStatsRects[6].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[6].iTop = SHIFT_Y + 265;		gArmorDescStatsRects[6].iRight = SHIFT_X + 168;	gArmorDescStatsRects[6].iBottom = SHIFT_Y + 276;
			gArmorDescStatsRects[7].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[7].iTop = SHIFT_Y + 277;		gArmorDescStatsRects[7].iRight = SHIFT_X + 168;	gArmorDescStatsRects[7].iBottom = SHIFT_Y + 288;
			gArmorDescStatsRects[8].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[8].iTop = SHIFT_Y + 289;		gArmorDescStatsRects[8].iRight = SHIFT_X + 168;	gArmorDescStatsRects[8].iBottom = SHIFT_Y + 300;
			gArmorDescStatsRects[9].iLeft = SHIFT_X + 111;	gArmorDescStatsRects[9].iTop = SHIFT_Y + 301;		gArmorDescStatsRects[9].iRight = SHIFT_X + 168;	gArmorDescStatsRects[9].iBottom = SHIFT_Y + 312;
			gArmorDescStatsRects[10].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[10].iTop = SHIFT_Y + 229;	gArmorDescStatsRects[10].iRight = SHIFT_X + 230;	gArmorDescStatsRects[10].iBottom = SHIFT_Y + 240;	// Third Column
			gArmorDescStatsRects[11].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[11].iTop = SHIFT_Y + 241;	gArmorDescStatsRects[11].iRight = SHIFT_X + 230;	gArmorDescStatsRects[11].iBottom = SHIFT_Y + 252;
			gArmorDescStatsRects[12].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[12].iTop = SHIFT_Y + 253;	gArmorDescStatsRects[12].iRight = SHIFT_X + 230;	gArmorDescStatsRects[12].iBottom = SHIFT_Y + 264;
			gArmorDescStatsRects[13].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[13].iTop = SHIFT_Y + 265;	gArmorDescStatsRects[13].iRight = SHIFT_X + 230;	gArmorDescStatsRects[13].iBottom = SHIFT_Y + 276;
			gArmorDescStatsRects[14].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[14].iTop = SHIFT_Y + 277;	gArmorDescStatsRects[14].iRight = SHIFT_X + 230;	gArmorDescStatsRects[14].iBottom = SHIFT_Y + 288;
			gArmorDescStatsRects[15].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[15].iTop = SHIFT_Y + 289;	gArmorDescStatsRects[15].iRight = SHIFT_X + 230;	gArmorDescStatsRects[15].iBottom = SHIFT_Y + 300;
			gArmorDescStatsRects[16].iLeft = SHIFT_X + 173;	gArmorDescStatsRects[16].iTop = SHIFT_Y + 301;	gArmorDescStatsRects[16].iRight = SHIFT_X + 230;	gArmorDescStatsRects[16].iBottom = SHIFT_Y + 312;
			gArmorDescStatsRects[17].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[17].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[17].iRight = SHIFT_X + 1;	gArmorDescStatsRects[17].iBottom = SHIFT_Y + 1;	// Placeholders
			gArmorDescStatsRects[18].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[18].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[18].iRight = SHIFT_X + 1;	gArmorDescStatsRects[18].iBottom = SHIFT_Y + 1;
			gArmorDescStatsRects[19].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[19].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[19].iRight = SHIFT_X + 1;	gArmorDescStatsRects[19].iBottom = SHIFT_Y + 1;

			gExplosiveDescStatsRects[0].iLeft = SHIFT_X + 46;		gExplosiveDescStatsRects[0].iTop = SHIFT_Y + 229;	gExplosiveDescStatsRects[0].iRight = SHIFT_X + 103;	gExplosiveDescStatsRects[0].iBottom = SHIFT_Y + 240;	// First Column
			gExplosiveDescStatsRects[1].iLeft = SHIFT_X + 46;		gExplosiveDescStatsRects[1].iTop = SHIFT_Y + 241;	gExplosiveDescStatsRects[1].iRight = SHIFT_X + 103;	gExplosiveDescStatsRects[1].iBottom = SHIFT_Y + 252;
			gExplosiveDescStatsRects[2].iLeft = SHIFT_X + 46;		gExplosiveDescStatsRects[2].iTop = SHIFT_Y + 253;	gExplosiveDescStatsRects[2].iRight = SHIFT_X + 103;	gExplosiveDescStatsRects[2].iBottom = SHIFT_Y + 264;
			gExplosiveDescStatsRects[3].iLeft = SHIFT_X + 46;		gExplosiveDescStatsRects[3].iTop = SHIFT_Y + 265;	gExplosiveDescStatsRects[3].iRight = SHIFT_X + 103;	gExplosiveDescStatsRects[3].iBottom = SHIFT_Y + 276;
			gExplosiveDescStatsRects[4].iLeft = SHIFT_X + 131;	gExplosiveDescStatsRects[4].iTop = SHIFT_Y + 229;	gExplosiveDescStatsRects[4].iRight = SHIFT_X + 147;	gExplosiveDescStatsRects[4].iBottom = SHIFT_Y + 264;	// Second Column
			gExplosiveDescStatsRects[5].iLeft = SHIFT_X + 113;	gExplosiveDescStatsRects[5].iTop = SHIFT_Y + 229;	gExplosiveDescStatsRects[5].iRight = SHIFT_X + 129;	gExplosiveDescStatsRects[5].iBottom = SHIFT_Y + 264;
			gExplosiveDescStatsRects[6].iLeft = SHIFT_X + 145;	gExplosiveDescStatsRects[6].iTop = SHIFT_Y + 229;	gExplosiveDescStatsRects[6].iRight = SHIFT_X + 165;	gExplosiveDescStatsRects[6].iBottom = SHIFT_Y + 264;
			gExplosiveDescStatsRects[7].iLeft = SHIFT_X + 111;	gExplosiveDescStatsRects[7].iTop = SHIFT_Y + 277;	gExplosiveDescStatsRects[7].iRight = SHIFT_X + 168;	gExplosiveDescStatsRects[7].iBottom = SHIFT_Y + 288;
			gExplosiveDescStatsRects[8].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[8].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[8].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[8].iBottom = SHIFT_Y + 1;	// Placeholders
			gExplosiveDescStatsRects[9].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[9].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[9].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[9].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[10].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[10].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[10].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[10].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[11].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[11].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[11].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[11].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[12].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[12].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[12].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[12].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[13].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[13].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[13].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[13].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[14].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[14].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[14].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[14].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[15].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[15].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[15].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[15].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[16].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[16].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[16].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[16].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[17].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[17].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[17].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[17].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[18].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[18].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[18].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[18].iBottom = SHIFT_Y + 1;
			gExplosiveDescStatsRects[19].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[19].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[19].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[19].iBottom = SHIFT_Y + 1;

			gMiscItemDescStatsRects[0].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[0].iTop = SHIFT_Y + 229;	gMiscItemDescStatsRects[0].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[0].iBottom = SHIFT_Y + 240; // First Column
			gMiscItemDescStatsRects[1].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[1].iTop = SHIFT_Y + 241;	gMiscItemDescStatsRects[1].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[1].iBottom = SHIFT_Y + 252;
			gMiscItemDescStatsRects[2].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[2].iTop = SHIFT_Y + 253;	gMiscItemDescStatsRects[2].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[2].iBottom = SHIFT_Y + 264;
			gMiscItemDescStatsRects[3].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[3].iTop = SHIFT_Y + 265;	gMiscItemDescStatsRects[3].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[3].iBottom = SHIFT_Y + 276;
			gMiscItemDescStatsRects[4].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[4].iTop = SHIFT_Y + 277;	gMiscItemDescStatsRects[4].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[4].iBottom = SHIFT_Y + 288;
			gMiscItemDescStatsRects[5].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[5].iTop = SHIFT_Y + 289;	gMiscItemDescStatsRects[5].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[5].iBottom = SHIFT_Y + 300;
			gMiscItemDescStatsRects[6].iLeft = SHIFT_X + 46;		gMiscItemDescStatsRects[6].iTop = SHIFT_Y + 301;	gMiscItemDescStatsRects[6].iRight = SHIFT_X + 103;	gMiscItemDescStatsRects[6].iBottom = SHIFT_Y + 312;
			gMiscItemDescStatsRects[7].iLeft = SHIFT_X + 144;		gMiscItemDescStatsRects[7].iTop = SHIFT_Y + 229;	gMiscItemDescStatsRects[7].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[7].iBottom = SHIFT_Y + 240;	// First Column
			gMiscItemDescStatsRects[8].iLeft = SHIFT_X + 144;		gMiscItemDescStatsRects[8].iTop = SHIFT_Y + 241;	gMiscItemDescStatsRects[8].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[8].iBottom = SHIFT_Y + 252;
			gMiscItemDescStatsRects[9].iLeft = SHIFT_X + 144;		gMiscItemDescStatsRects[9].iTop = SHIFT_Y + 253;	gMiscItemDescStatsRects[9].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[9].iBottom = SHIFT_Y + 264;
			gMiscItemDescStatsRects[10].iLeft = SHIFT_X + 144;	gMiscItemDescStatsRects[10].iTop = SHIFT_Y + 265;	gMiscItemDescStatsRects[10].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[10].iBottom = SHIFT_Y + 276;
			gMiscItemDescStatsRects[11].iLeft = SHIFT_X + 144;	gMiscItemDescStatsRects[11].iTop = SHIFT_Y + 277;	gMiscItemDescStatsRects[11].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[11].iBottom = SHIFT_Y + 288;
			gMiscItemDescStatsRects[12].iLeft = SHIFT_X + 144;	gMiscItemDescStatsRects[12].iTop = SHIFT_Y + 289;	gMiscItemDescStatsRects[12].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[12].iBottom = SHIFT_Y + 300;
			gMiscItemDescStatsRects[13].iLeft = SHIFT_X + 144;	gMiscItemDescStatsRects[13].iTop = SHIFT_Y + 301;	gMiscItemDescStatsRects[13].iRight = SHIFT_X + 230;	gMiscItemDescStatsRects[13].iBottom = SHIFT_Y + 312;
			gMiscItemDescStatsRects[14].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[14].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[14].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[14].iBottom = SHIFT_Y + 1;	// Placeholders
			gMiscItemDescStatsRects[15].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[15].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[15].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[15].iBottom = SHIFT_Y + 1;
			gMiscItemDescStatsRects[16].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[16].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[16].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[16].iBottom = SHIFT_Y + 1;
			gMiscItemDescStatsRects[17].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[17].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[17].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[17].iBottom = SHIFT_Y + 1;
			gMiscItemDescStatsRects[18].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[18].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[18].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[18].iBottom = SHIFT_Y + 1;
			gMiscItemDescStatsRects[19].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[19].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[19].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[19].iBottom = SHIFT_Y + 1;
		...
		else
		{
			...
			{
				// Icon Locations
				gMiscItemStatsEDB[0].sX = SHIFT_X + 203;	gMiscItemStatsEDB[0].sY = SHIFT_Y + 44;	gMiscItemStatsEDB[0].sValDx = 0;	// 0) COL 1; ROW 1
				gMiscItemStatsEDB[1].sX = SHIFT_X + 203;	gMiscItemStatsEDB[1].sY = SHIFT_Y + 56;	gMiscItemStatsEDB[1].sValDx = 0;	// 1) COL 1; ROW 2
				gMiscItemStatsEDB[2].sX = SHIFT_X + 203;	gMiscItemStatsEDB[2].sY = SHIFT_Y + 68;	gMiscItemStatsEDB[2].sValDx = 0;	// 2) COL 1; ROW 3
				gMiscItemStatsEDB[3].sX = SHIFT_X + 203;	gMiscItemStatsEDB[3].sY = SHIFT_Y + 80;	gMiscItemStatsEDB[3].sValDx = 0;	// 3) COL 1; ROW 4
				gMiscItemStatsEDB[4].sX = SHIFT_X + 203;	gMiscItemStatsEDB[4].sY = SHIFT_Y + 92;	gMiscItemStatsEDB[4].sValDx = 0;	// 4) COL 1; ROW 5
				gMiscItemStatsEDB[5].sX = SHIFT_X + 203;	gMiscItemStatsEDB[5].sY = SHIFT_Y + 104;	gMiscItemStatsEDB[5].sValDx = 0;	// 5) COL 1; ROW 6
				gMiscItemStatsEDB[6].sX = SHIFT_X + 203;	gMiscItemStatsEDB[6].sY = SHIFT_Y + 116;	gMiscItemStatsEDB[6].sValDx = 0;	// 6) COL 1; ROW 7
				gMiscItemStatsEDB[7].sX = SHIFT_X + 203;	gMiscItemStatsEDB[7].sY = SHIFT_Y + 128;	gMiscItemStatsEDB[7].sValDx = 0;	// 7) COL 1; ROW 8
				gMiscItemStatsEDB[8].sX = SHIFT_X + 203;	gMiscItemStatsEDB[8].sY = SHIFT_Y + 140;	gMiscItemStatsEDB[8].sValDx = 0;	// 8) COL 1; ROW 9
				gMiscItemStatsEDB[9].sX = SHIFT_X + 203;	gMiscItemStatsEDB[9].sY = SHIFT_Y + 152;	gMiscItemStatsEDB[9].sValDx = 0;	// 9) COL 1; ROW 10
				gMiscItemStatsEDB[10].sX = SHIFT_X + 203;	gMiscItemStatsEDB[10].sY = SHIFT_Y + 164;	gMiscItemStatsEDB[10].sValDx = 0;	// 10) COL 1; ROW 11
				gMiscItemStatsEDB[11].sX = SHIFT_X + 203;	gMiscItemStatsEDB[11].sY = SHIFT_Y + 176;	gMiscItemStatsEDB[11].sValDx = 0;	// 11) COL 1; ROW 12
				// EQUALS signs Locations
				gMiscItemStatsEDB[12].sX = SHIFT_X + 283;	gMiscItemStatsEDB[12].sY = SHIFT_Y + 44;	gMiscItemStatsEDB[12].sValDx = 12;	// 12) COL 1; ROW 1
				gMiscItemStatsEDB[13].sX = SHIFT_X + 283;	gMiscItemStatsEDB[13].sY = SHIFT_Y + 56;	gMiscItemStatsEDB[13].sValDx = 12;	// 13) COL 1; ROW 2
				gMiscItemStatsEDB[14].sX = SHIFT_X + 283;	gMiscItemStatsEDB[14].sY = SHIFT_Y + 68;	gMiscItemStatsEDB[14].sValDx = 12;	// 14) COL 1; ROW 3
				gMiscItemStatsEDB[15].sX = SHIFT_X + 283;	gMiscItemStatsEDB[15].sY = SHIFT_Y + 80;	gMiscItemStatsEDB[15].sValDx = 12;	// 15) COL 1; ROW 4
				gMiscItemStatsEDB[16].sX = SHIFT_X + 283;	gMiscItemStatsEDB[16].sY = SHIFT_Y + 92;	gMiscItemStatsEDB[16].sValDx = 12;	// 16) COL 1; ROW 5
				gMiscItemStatsEDB[17].sX = SHIFT_X + 283;	gMiscItemStatsEDB[17].sY = SHIFT_Y + 104;	gMiscItemStatsEDB[17].sValDx = 12;	// 17) COL 1; ROW 6
				gMiscItemStatsEDB[18].sX = SHIFT_X + 283;	gMiscItemStatsEDB[18].sY = SHIFT_Y + 116;	gMiscItemStatsEDB[18].sValDx = 12;	// 18) COL 1; ROW 7
				gMiscItemStatsEDB[19].sX = SHIFT_X + 283;	gMiscItemStatsEDB[19].sY = SHIFT_Y + 128;	gMiscItemStatsEDB[19].sValDx = 12;	// 19) COL 1; ROW 8
				gMiscItemStatsEDB[20].sX = SHIFT_X + 283;	gMiscItemStatsEDB[20].sY = SHIFT_Y + 140;	gMiscItemStatsEDB[20].sValDx = 12;	// 20) COL 1; ROW 9
				gMiscItemStatsEDB[21].sX = SHIFT_X + 283;	gMiscItemStatsEDB[21].sY = SHIFT_Y + 152;	gMiscItemStatsEDB[21].sValDx = 12;	// 21) COL 1; ROW 10
				gMiscItemStatsEDB[22].sX = SHIFT_X + 283;	gMiscItemStatsEDB[22].sY = SHIFT_Y + 164;	gMiscItemStatsEDB[22].sValDx = 12;	// 22) COL 1; ROW 11
				gMiscItemStatsEDB[23].sX = SHIFT_X + 283;	gMiscItemStatsEDB[23].sY = SHIFT_Y + 176;	gMiscItemStatsEDB[23].sValDx = 12;	// 23) COL 1; ROW 12
				// MISC
				gMiscItemStatsEDB[24].sX = SHIFT_X + 0;	gMiscItemStatsEDB[24].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[24].sValDx = 0;
				gMiscItemStatsEDB[25].sX = SHIFT_X + 0;	gMiscItemStatsEDB[25].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[25].sValDx = 0;
				gMiscItemStatsEDB[26].sX = SHIFT_X + 0;	gMiscItemStatsEDB[26].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[26].sValDx = 0;
				gMiscItemStatsEDB[27].sX = SHIFT_X + 0;	gMiscItemStatsEDB[27].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[27].sValDx = 0;

				gWeaponDescStatsRects[0].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[0].iTop = SHIFT_Y + 42;		gWeaponDescStatsRects[0].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[0].iBottom = SHIFT_Y + 53;	// First Column
				gWeaponDescStatsRects[1].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[1].iTop = SHIFT_Y + 54;		gWeaponDescStatsRects[1].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[1].iBottom = SHIFT_Y + 65;
				gWeaponDescStatsRects[2].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[2].iTop = SHIFT_Y + 66;		gWeaponDescStatsRects[2].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[2].iBottom = SHIFT_Y + 77;
				gWeaponDescStatsRects[3].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[3].iTop = SHIFT_Y + 78;		gWeaponDescStatsRects[3].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[3].iBottom = SHIFT_Y + 89;
				gWeaponDescStatsRects[4].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[4].iTop = SHIFT_Y + 90;		gWeaponDescStatsRects[4].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[4].iBottom = SHIFT_Y + 101;
				gWeaponDescStatsRects[5].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[5].iTop = SHIFT_Y + 102;	gWeaponDescStatsRects[5].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[5].iBottom = SHIFT_Y + 113;
				gWeaponDescStatsRects[6].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[6].iTop = SHIFT_Y + 114;	gWeaponDescStatsRects[6].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[6].iBottom = SHIFT_Y + 125;
				gWeaponDescStatsRects[7].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[7].iTop = SHIFT_Y + 54;		gWeaponDescStatsRects[7].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[7].iBottom = SHIFT_Y + 65;	// Second Column
				gWeaponDescStatsRects[8].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[8].iTop = SHIFT_Y + 66;		gWeaponDescStatsRects[8].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[8].iBottom = SHIFT_Y + 77;
				gWeaponDescStatsRects[9].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[9].iTop = SHIFT_Y + 78;		gWeaponDescStatsRects[9].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[9].iBottom = SHIFT_Y + 89;
				gWeaponDescStatsRects[10].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[10].iTop = SHIFT_Y + 90;	gWeaponDescStatsRects[10].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[10].iBottom = SHIFT_Y + 101;
				gWeaponDescStatsRects[11].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[11].iTop = SHIFT_Y + 102;	gWeaponDescStatsRects[11].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[11].iBottom = SHIFT_Y + 113;
				gWeaponDescStatsRects[12].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[12].iTop = SHIFT_Y + 114;	gWeaponDescStatsRects[12].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[12].iBottom = SHIFT_Y + 125;
				gWeaponDescStatsRects[13].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[13].iTop = SHIFT_Y + 134;	gWeaponDescStatsRects[13].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[13].iBottom = SHIFT_Y + 145;
				gWeaponDescStatsRects[14].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[14].iTop = SHIFT_Y + 146;	gWeaponDescStatsRects[14].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[14].iBottom = SHIFT_Y + 157;
				gWeaponDescStatsRects[15].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[15].iTop = SHIFT_Y + 158;	gWeaponDescStatsRects[15].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[15].iBottom = SHIFT_Y + 169;
				gWeaponDescStatsRects[16].iLeft = SHIFT_X + 267;	gWeaponDescStatsRects[16].iTop = SHIFT_Y + 170;	gWeaponDescStatsRects[16].iRight = SHIFT_X + 325;	gWeaponDescStatsRects[16].iBottom = SHIFT_Y + 181;
				gWeaponDescStatsRects[17].iLeft = SHIFT_X + 225;	gWeaponDescStatsRects[17].iTop = SHIFT_Y + 134;	gWeaponDescStatsRects[17].iRight = SHIFT_X + 241;	gWeaponDescStatsRects[17].iBottom = SHIFT_Y + 157;
				gWeaponDescStatsRects[18].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[18].iTop = SHIFT_Y + 158;	gWeaponDescStatsRects[18].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[18].iBottom = SHIFT_Y + 169;
				gWeaponDescStatsRects[19].iLeft = SHIFT_X + 202;	gWeaponDescStatsRects[19].iTop = SHIFT_Y + 170;	gWeaponDescStatsRects[19].iRight = SHIFT_X + 260;	gWeaponDescStatsRects[19].iBottom = SHIFT_Y + 181;

				gAmmoDescStatsRects[0].iLeft = SHIFT_X + 202;		gAmmoDescStatsRects[0].iTop = SHIFT_Y + 42;	gAmmoDescStatsRects[0].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[0].iBottom = SHIFT_Y + 53;	// First Column
				gAmmoDescStatsRects[1].iLeft = SHIFT_X + 202;		gAmmoDescStatsRects[1].iTop = SHIFT_Y + 54;	gAmmoDescStatsRects[1].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[1].iBottom = SHIFT_Y + 65;
				gAmmoDescStatsRects[2].iLeft = SHIFT_X + 202;		gAmmoDescStatsRects[2].iTop = SHIFT_Y + 66;	gAmmoDescStatsRects[2].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[2].iBottom = SHIFT_Y + 77;
				gAmmoDescStatsRects[3].iLeft = SHIFT_X + 269;		gAmmoDescStatsRects[3].iTop = SHIFT_Y + 42;	gAmmoDescStatsRects[3].iRight = SHIFT_X + 291;	gAmmoDescStatsRects[3].iBottom = SHIFT_Y + 65;	// Second Column
				gAmmoDescStatsRects[4].iLeft = SHIFT_X + 296;		gAmmoDescStatsRects[4].iTop = SHIFT_Y + 42;	gAmmoDescStatsRects[4].iRight = SHIFT_X + 321;	gAmmoDescStatsRects[4].iBottom = SHIFT_Y + 65;
				gAmmoDescStatsRects[5].iLeft = SHIFT_X + 269;		gAmmoDescStatsRects[5].iTop = SHIFT_Y + 66;	gAmmoDescStatsRects[5].iRight = SHIFT_X + 291;	gAmmoDescStatsRects[5].iBottom = SHIFT_Y + 89;
				gAmmoDescStatsRects[6].iLeft = SHIFT_X + 296;		gAmmoDescStatsRects[6].iTop = SHIFT_Y + 66;	gAmmoDescStatsRects[6].iRight = SHIFT_X + 321;	gAmmoDescStatsRects[6].iBottom = SHIFT_Y + 89;
				gAmmoDescStatsRects[7].iLeft = SHIFT_X + 269;		gAmmoDescStatsRects[7].iTop = SHIFT_Y + 90;	gAmmoDescStatsRects[7].iRight = SHIFT_X + 291;	gAmmoDescStatsRects[7].iBottom = SHIFT_Y + 113;
				gAmmoDescStatsRects[8].iLeft = SHIFT_X + 202;		gAmmoDescStatsRects[8].iTop = SHIFT_Y + 134;	gAmmoDescStatsRects[8].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[8].iBottom = SHIFT_Y + 145;	// Third Column
				gAmmoDescStatsRects[9].iLeft = SHIFT_X + 202;		gAmmoDescStatsRects[9].iTop = SHIFT_Y + 158;	gAmmoDescStatsRects[9].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[9].iBottom = SHIFT_Y + 169;
				gAmmoDescStatsRects[10].iLeft = SHIFT_X + 267;	gAmmoDescStatsRects[10].iTop = SHIFT_Y + 134;	gAmmoDescStatsRects[10].iRight = SHIFT_X + 325;	gAmmoDescStatsRects[10].iBottom = SHIFT_Y + 145;
				gAmmoDescStatsRects[11].iLeft = SHIFT_X + 267;	gAmmoDescStatsRects[11].iTop = SHIFT_Y + 146;	gAmmoDescStatsRects[11].iRight = SHIFT_X + 325;	gAmmoDescStatsRects[11].iBottom = SHIFT_Y + 157;
				gAmmoDescStatsRects[12].iLeft = SHIFT_X + 267;	gAmmoDescStatsRects[12].iTop = SHIFT_Y + 158;	gAmmoDescStatsRects[12].iRight = SHIFT_X + 325;	gAmmoDescStatsRects[12].iBottom = SHIFT_Y + 169;	// Fourth Column
				gAmmoDescStatsRects[13].iLeft = SHIFT_X + 202;	gAmmoDescStatsRects[13].iTop = SHIFT_Y + 170;	gAmmoDescStatsRects[13].iRight = SHIFT_X + 260;	gAmmoDescStatsRects[13].iBottom = SHIFT_Y + 181;
				gAmmoDescStatsRects[14].iLeft = SHIFT_X + 267;	gAmmoDescStatsRects[14].iTop = SHIFT_Y + 170;	gAmmoDescStatsRects[14].iRight = SHIFT_X + 325;	gAmmoDescStatsRects[14].iBottom = SHIFT_Y + 181;	// Placeholders
				gAmmoDescStatsRects[15].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[15].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[15].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[15].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[16].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[16].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[16].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[16].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[17].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[17].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[17].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[17].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[18].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[18].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[18].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[18].iBottom = SHIFT_Y + 1;
				...
				gArmorDescStatsRects[0].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[0].iTop = SHIFT_Y + 42;		gArmorDescStatsRects[0].iRight = SHIFT_X + 260;	gArmorDescStatsRects[0].iBottom = SHIFT_Y + 53;	// First Column
				gArmorDescStatsRects[1].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[1].iTop = SHIFT_Y + 54;		gArmorDescStatsRects[1].iRight = SHIFT_X + 260;	gArmorDescStatsRects[1].iBottom = SHIFT_Y + 65;
				gArmorDescStatsRects[2].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[2].iTop = SHIFT_Y + 66;		gArmorDescStatsRects[2].iRight = SHIFT_X + 260;	gArmorDescStatsRects[2].iBottom = SHIFT_Y + 77;
				gArmorDescStatsRects[3].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[3].iTop = SHIFT_Y + 42;		gArmorDescStatsRects[3].iRight = SHIFT_X + 325;	gArmorDescStatsRects[3].iBottom = SHIFT_Y + 53;	// Second Column
				gArmorDescStatsRects[4].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[4].iTop = SHIFT_Y + 54;		gArmorDescStatsRects[4].iRight = SHIFT_X + 325;	gArmorDescStatsRects[4].iBottom = SHIFT_Y + 65;
				gArmorDescStatsRects[5].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[5].iTop = SHIFT_Y + 66;		gArmorDescStatsRects[5].iRight = SHIFT_X + 325;	gArmorDescStatsRects[5].iBottom = SHIFT_Y + 77;
				gArmorDescStatsRects[6].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[6].iTop = SHIFT_Y + 78;		gArmorDescStatsRects[6].iRight = SHIFT_X + 325;	gArmorDescStatsRects[6].iBottom = SHIFT_Y + 89;
				gArmorDescStatsRects[7].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[7].iTop = SHIFT_Y + 90;		gArmorDescStatsRects[7].iRight = SHIFT_X + 325;	gArmorDescStatsRects[7].iBottom = SHIFT_Y + 101;
				gArmorDescStatsRects[8].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[8].iTop = SHIFT_Y + 102;		gArmorDescStatsRects[8].iRight = SHIFT_X + 325;	gArmorDescStatsRects[8].iBottom = SHIFT_Y + 113;
				gArmorDescStatsRects[9].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[9].iTop = SHIFT_Y + 114;		gArmorDescStatsRects[9].iRight = SHIFT_X + 325;	gArmorDescStatsRects[9].iBottom = SHIFT_Y + 125;
				gArmorDescStatsRects[10].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[10].iTop = SHIFT_Y + 134;	gArmorDescStatsRects[10].iRight = SHIFT_X + 260;	gArmorDescStatsRects[10].iBottom = SHIFT_Y + 145;	// Third Column
				gArmorDescStatsRects[11].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[11].iTop = SHIFT_Y + 146;	gArmorDescStatsRects[11].iRight = SHIFT_X + 260;	gArmorDescStatsRects[11].iBottom = SHIFT_Y + 157;
				gArmorDescStatsRects[12].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[12].iTop = SHIFT_Y + 158;	gArmorDescStatsRects[12].iRight = SHIFT_X + 260;	gArmorDescStatsRects[12].iBottom = SHIFT_Y + 169;
				gArmorDescStatsRects[13].iLeft = SHIFT_X + 202;	gArmorDescStatsRects[13].iTop = SHIFT_Y + 170;	gArmorDescStatsRects[13].iRight = SHIFT_X + 260;	gArmorDescStatsRects[13].iBottom = SHIFT_Y + 181;
				gArmorDescStatsRects[14].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[14].iTop = SHIFT_Y + 134;	gArmorDescStatsRects[14].iRight = SHIFT_X + 325;	gArmorDescStatsRects[14].iBottom = SHIFT_Y + 145;	// Fourth Column
				gArmorDescStatsRects[15].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[15].iTop = SHIFT_Y + 146;	gArmorDescStatsRects[15].iRight = SHIFT_X + 325;	gArmorDescStatsRects[15].iBottom = SHIFT_Y + 157;
				gArmorDescStatsRects[16].iLeft = SHIFT_X + 267;	gArmorDescStatsRects[16].iTop = SHIFT_Y + 158;	gArmorDescStatsRects[16].iRight = SHIFT_X + 325;	gArmorDescStatsRects[16].iBottom = SHIFT_Y + 169;
				gArmorDescStatsRects[17].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[17].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[17].iRight = SHIFT_X + 1;	gArmorDescStatsRects[17].iBottom = SHIFT_Y + 1;	// Placeholders
				gArmorDescStatsRects[18].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[18].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[18].iRight = SHIFT_X + 1;	gArmorDescStatsRects[18].iBottom = SHIFT_Y + 1;
				gArmorDescStatsRects[19].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[19].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[19].iRight = SHIFT_X + 1;	gArmorDescStatsRects[19].iBottom = SHIFT_Y + 1;

				gExplosiveDescStatsRects[0].iLeft = SHIFT_X + 202;	gExplosiveDescStatsRects[0].iTop = SHIFT_Y + 42;	gExplosiveDescStatsRects[0].iRight = SHIFT_X + 260;	gExplosiveDescStatsRects[0].iBottom = SHIFT_Y + 53;	// First Column
				gExplosiveDescStatsRects[1].iLeft = SHIFT_X + 202;	gExplosiveDescStatsRects[1].iTop = SHIFT_Y + 54;	gExplosiveDescStatsRects[1].iRight = SHIFT_X + 260;	gExplosiveDescStatsRects[1].iBottom = SHIFT_Y + 65;
				gExplosiveDescStatsRects[2].iLeft = SHIFT_X + 202;	gExplosiveDescStatsRects[2].iTop = SHIFT_Y + 66;	gExplosiveDescStatsRects[2].iRight = SHIFT_X + 260;	gExplosiveDescStatsRects[2].iBottom = SHIFT_Y + 77;
				gExplosiveDescStatsRects[3].iLeft = SHIFT_X + 202;	gExplosiveDescStatsRects[3].iTop = SHIFT_Y + 78;	gExplosiveDescStatsRects[3].iRight = SHIFT_X + 260;	gExplosiveDescStatsRects[3].iBottom = SHIFT_Y + 89;
				gExplosiveDescStatsRects[4].iLeft = SHIFT_X + 290;	gExplosiveDescStatsRects[4].iTop = SHIFT_Y + 42;	gExplosiveDescStatsRects[4].iRight = SHIFT_X + 306;	gExplosiveDescStatsRects[4].iBottom = SHIFT_Y + 77;	// Second Column
				gExplosiveDescStatsRects[5].iLeft = SHIFT_X + 269;	gExplosiveDescStatsRects[5].iTop = SHIFT_Y + 42;	gExplosiveDescStatsRects[5].iRight = SHIFT_X + 285;	gExplosiveDescStatsRects[5].iBottom = SHIFT_Y + 77;
				gExplosiveDescStatsRects[6].iLeft = SHIFT_X + 301;	gExplosiveDescStatsRects[6].iTop = SHIFT_Y + 42;	gExplosiveDescStatsRects[6].iRight = SHIFT_X + 321;	gExplosiveDescStatsRects[6].iBottom = SHIFT_Y + 77;
				gExplosiveDescStatsRects[7].iLeft = SHIFT_X + 267;	gExplosiveDescStatsRects[7].iTop = SHIFT_Y + 90;	gExplosiveDescStatsRects[7].iRight = SHIFT_X + 325;	gExplosiveDescStatsRects[7].iBottom = SHIFT_Y + 101;
				gExplosiveDescStatsRects[8].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[8].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[8].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[8].iBottom = SHIFT_Y + 1;	// Placeholders
				gExplosiveDescStatsRects[9].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[9].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[9].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[9].iBottom = SHIFT_Y + 1;
				gExplosiveDescStatsRects[10].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[10].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[10].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[10].iBottom = SHIFT_Y + 1;
				gExplosiveDescStatsRects[11].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[11].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[11].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[11].iBottom = SHIFT_Y + 1;
				...
				gMiscItemDescStatsRects[0].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[0].iTop = SHIFT_Y + 42;	gMiscItemDescStatsRects[0].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[0].iBottom = SHIFT_Y + 53; // Only one column for misc items in tactical - 12 fields.
				gMiscItemDescStatsRects[1].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[1].iTop = SHIFT_Y + 54;	gMiscItemDescStatsRects[1].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[1].iBottom = SHIFT_Y + 65;
				gMiscItemDescStatsRects[2].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[2].iTop = SHIFT_Y + 66;	gMiscItemDescStatsRects[2].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[2].iBottom = SHIFT_Y + 77;
				gMiscItemDescStatsRects[3].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[3].iTop = SHIFT_Y + 78;	gMiscItemDescStatsRects[3].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[3].iBottom = SHIFT_Y + 89;
				gMiscItemDescStatsRects[4].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[4].iTop = SHIFT_Y + 90;	gMiscItemDescStatsRects[4].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[4].iBottom = SHIFT_Y + 101;
				gMiscItemDescStatsRects[5].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[5].iTop = SHIFT_Y + 102;	gMiscItemDescStatsRects[5].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[5].iBottom = SHIFT_Y + 113;
				gMiscItemDescStatsRects[6].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[6].iTop = SHIFT_Y + 114;	gMiscItemDescStatsRects[6].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[6].iBottom = SHIFT_Y + 125;
				gMiscItemDescStatsRects[7].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[7].iTop = SHIFT_Y + 126;	gMiscItemDescStatsRects[7].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[7].iBottom = SHIFT_Y + 137;
				gMiscItemDescStatsRects[8].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[8].iTop = SHIFT_Y + 138;	gMiscItemDescStatsRects[8].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[8].iBottom = SHIFT_Y + 149;
				gMiscItemDescStatsRects[9].iLeft = SHIFT_X + 202;		gMiscItemDescStatsRects[9].iTop = SHIFT_Y + 150;	gMiscItemDescStatsRects[9].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[9].iBottom = SHIFT_Y + 161;
				gMiscItemDescStatsRects[10].iLeft = SHIFT_X + 202;	gMiscItemDescStatsRects[10].iTop = SHIFT_Y + 162;	gMiscItemDescStatsRects[10].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[10].iBottom = SHIFT_Y + 173;
				gMiscItemDescStatsRects[11].iLeft = SHIFT_X + 202;	gMiscItemDescStatsRects[11].iTop = SHIFT_Y + 174;	gMiscItemDescStatsRects[11].iRight = SHIFT_X + 325;	gMiscItemDescStatsRects[11].iBottom = SHIFT_Y + 185;
				gMiscItemDescStatsRects[12].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[12].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[12].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[12].iBottom = SHIFT_Y + 1;	// Placeholders
				gMiscItemDescStatsRects[13].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[13].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[13].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[13].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[14].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[14].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[14].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[14].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[15].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[15].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[15].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[15].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[16].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[16].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[16].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[16].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[17].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[17].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[17].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[17].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[18].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[18].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[18].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[18].iBottom = SHIFT_Y + 1;
			...
			{
				// Icon Locations
				gMiscItemStatsEDB[0].sX = SHIFT_X + 274;	gMiscItemStatsEDB[0].sY = SHIFT_Y + 14;	gMiscItemStatsEDB[0].sValDx = 0;	// 0) COL 1; ROW 1
				gMiscItemStatsEDB[1].sX = SHIFT_X + 274;	gMiscItemStatsEDB[1].sY = SHIFT_Y + 26;	gMiscItemStatsEDB[1].sValDx = 0;	// 1) COL 1; ROW 2
				gMiscItemStatsEDB[2].sX = SHIFT_X + 274;	gMiscItemStatsEDB[2].sY = SHIFT_Y + 38;	gMiscItemStatsEDB[2].sValDx = 0;	// 2) COL 1; ROW 3
				gMiscItemStatsEDB[3].sX = SHIFT_X + 274;	gMiscItemStatsEDB[3].sY = SHIFT_Y + 50;	gMiscItemStatsEDB[3].sValDx = 0;	// 3) COL 1; ROW 4
				gMiscItemStatsEDB[4].sX = SHIFT_X + 274;	gMiscItemStatsEDB[4].sY = SHIFT_Y + 62;	gMiscItemStatsEDB[4].sValDx = 0;	// 4) COL 1; ROW 5
				gMiscItemStatsEDB[5].sX = SHIFT_X + 274;	gMiscItemStatsEDB[5].sY = SHIFT_Y + 74;	gMiscItemStatsEDB[5].sValDx = 0;	// 5) COL 1; ROW 6
				gMiscItemStatsEDB[6].sX = SHIFT_X + 274;	gMiscItemStatsEDB[6].sY = SHIFT_Y + 86;	gMiscItemStatsEDB[6].sValDx = 0;	// 6) COL 1; ROW 7
				gMiscItemStatsEDB[7].sX = SHIFT_X + 375;	gMiscItemStatsEDB[7].sY = SHIFT_Y + 14;	gMiscItemStatsEDB[7].sValDx = 0;	// 7) COL 1; ROW 8
				gMiscItemStatsEDB[8].sX = SHIFT_X + 375;	gMiscItemStatsEDB[8].sY = SHIFT_Y + 26;	gMiscItemStatsEDB[8].sValDx = 0;	// 8) COL 1; ROW 9
				gMiscItemStatsEDB[9].sX = SHIFT_X + 375;	gMiscItemStatsEDB[9].sY = SHIFT_Y + 38;	gMiscItemStatsEDB[9].sValDx = 0;	// 9) COL 1; ROW 10
				gMiscItemStatsEDB[10].sX = SHIFT_X + 375;	gMiscItemStatsEDB[10].sY = SHIFT_Y + 50;	gMiscItemStatsEDB[10].sValDx = 0;	// 10) COL 1; ROW 11
				gMiscItemStatsEDB[11].sX = SHIFT_X + 375;	gMiscItemStatsEDB[11].sY = SHIFT_Y + 62;	gMiscItemStatsEDB[11].sValDx = 0;	// 11) COL 1; ROW 12
				// EQUALS signs Locations
				gMiscItemStatsEDB[12].sX = SHIFT_X + 324;	gMiscItemStatsEDB[12].sY = SHIFT_Y + 14;	gMiscItemStatsEDB[12].sValDx = 12;	// 12) COL 1; ROW 1
				gMiscItemStatsEDB[13].sX = SHIFT_X + 324;	gMiscItemStatsEDB[13].sY = SHIFT_Y + 26;	gMiscItemStatsEDB[13].sValDx = 12;	// 13) COL 1; ROW 2
				gMiscItemStatsEDB[14].sX = SHIFT_X + 324;	gMiscItemStatsEDB[14].sY = SHIFT_Y + 38;	gMiscItemStatsEDB[14].sValDx = 12;	// 14) COL 1; ROW 3
				gMiscItemStatsEDB[15].sX = SHIFT_X + 324;	gMiscItemStatsEDB[15].sY = SHIFT_Y + 50;	gMiscItemStatsEDB[15].sValDx = 12;	// 15) COL 1; ROW 4
				gMiscItemStatsEDB[16].sX = SHIFT_X + 324;	gMiscItemStatsEDB[16].sY = SHIFT_Y + 62;	gMiscItemStatsEDB[16].sValDx = 12;	// 16) COL 1; ROW 5
				gMiscItemStatsEDB[17].sX = SHIFT_X + 324;	gMiscItemStatsEDB[17].sY = SHIFT_Y + 74;	gMiscItemStatsEDB[17].sValDx = 12;	// 17) COL 1; ROW 6
				gMiscItemStatsEDB[18].sX = SHIFT_X + 324;	gMiscItemStatsEDB[18].sY = SHIFT_Y + 86;	gMiscItemStatsEDB[18].sValDx = 12;	// 18) COL 1; ROW 7
				gMiscItemStatsEDB[19].sX = SHIFT_X + 425;	gMiscItemStatsEDB[19].sY = SHIFT_Y + 14;	gMiscItemStatsEDB[19].sValDx = 12;	// 19) COL 1; ROW 8
				gMiscItemStatsEDB[20].sX = SHIFT_X + 425;	gMiscItemStatsEDB[20].sY = SHIFT_Y + 26;	gMiscItemStatsEDB[20].sValDx = 12;	// 20) COL 1; ROW 9
				gMiscItemStatsEDB[21].sX = SHIFT_X + 425;	gMiscItemStatsEDB[21].sY = SHIFT_Y + 38;	gMiscItemStatsEDB[21].sValDx = 12;	// 21) COL 1; ROW 10
				gMiscItemStatsEDB[22].sX = SHIFT_X + 425;	gMiscItemStatsEDB[22].sY = SHIFT_Y + 50;	gMiscItemStatsEDB[22].sValDx = 12;	// 22) COL 1; ROW 11
				gMiscItemStatsEDB[23].sX = SHIFT_X + 425;	gMiscItemStatsEDB[23].sY = SHIFT_Y + 62;	gMiscItemStatsEDB[23].sValDx = 12;	// 23) COL 1; ROW 12
				// MISC
				gMiscItemStatsEDB[24].sX = SHIFT_X + 0;	gMiscItemStatsEDB[24].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[24].sValDx = 0;
				gMiscItemStatsEDB[25].sX = SHIFT_X + 0;	gMiscItemStatsEDB[25].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[25].sValDx = 0;
				gMiscItemStatsEDB[26].sX = SHIFT_X + 0;	gMiscItemStatsEDB[26].sY = SHIFT_Y + 0;	gMiscItemStatsEDB[26].sValDx = 0;
				...
				gWeaponDescStatsRects[0].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[0].iTop = SHIFT_Y + 12;		gWeaponDescStatsRects[0].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[0].iBottom = SHIFT_Y + 23;	// First Column
				gWeaponDescStatsRects[1].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[1].iTop = SHIFT_Y + 24;		gWeaponDescStatsRects[1].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[1].iBottom = SHIFT_Y + 35;
				gWeaponDescStatsRects[2].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[2].iTop = SHIFT_Y + 36;		gWeaponDescStatsRects[2].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[2].iBottom = SHIFT_Y + 47;
				gWeaponDescStatsRects[3].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[3].iTop = SHIFT_Y + 48;		gWeaponDescStatsRects[3].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[3].iBottom = SHIFT_Y + 59;
				gWeaponDescStatsRects[4].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[4].iTop = SHIFT_Y + 60;		gWeaponDescStatsRects[4].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[4].iBottom = SHIFT_Y + 71;
				gWeaponDescStatsRects[5].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[5].iTop = SHIFT_Y + 72;		gWeaponDescStatsRects[5].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[5].iBottom = SHIFT_Y + 83;
				gWeaponDescStatsRects[6].iLeft = SHIFT_X + 273;	gWeaponDescStatsRects[6].iTop = SHIFT_Y + 84;		gWeaponDescStatsRects[6].iRight = SHIFT_X + 331;	gWeaponDescStatsRects[6].iBottom = SHIFT_Y + 95;
				gWeaponDescStatsRects[7].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[7].iTop = SHIFT_Y + 24;		gWeaponDescStatsRects[7].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[7].iBottom = SHIFT_Y + 35;	// Second Column
				gWeaponDescStatsRects[8].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[8].iTop = SHIFT_Y + 36;		gWeaponDescStatsRects[8].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[8].iBottom = SHIFT_Y + 47;
				gWeaponDescStatsRects[9].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[9].iTop = SHIFT_Y + 48;		gWeaponDescStatsRects[9].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[9].iBottom = SHIFT_Y + 59;
				gWeaponDescStatsRects[10].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[10].iTop = SHIFT_Y + 60;	gWeaponDescStatsRects[10].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[10].iBottom = SHIFT_Y + 71;
				gWeaponDescStatsRects[11].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[11].iTop = SHIFT_Y + 72;	gWeaponDescStatsRects[11].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[11].iBottom = SHIFT_Y + 83;
				gWeaponDescStatsRects[12].iLeft = SHIFT_X + 340;	gWeaponDescStatsRects[12].iTop = SHIFT_Y + 84;	gWeaponDescStatsRects[12].iRight = SHIFT_X + 398;	gWeaponDescStatsRects[12].iBottom = SHIFT_Y + 95;
				gWeaponDescStatsRects[13].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[13].iTop = SHIFT_Y + 36;	gWeaponDescStatsRects[13].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[13].iBottom = SHIFT_Y + 47;	// These are non-sequential!
				gWeaponDescStatsRects[14].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[14].iTop = SHIFT_Y + 48;	gWeaponDescStatsRects[14].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[14].iBottom = SHIFT_Y + 59;
				gWeaponDescStatsRects[15].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[15].iTop = SHIFT_Y + 60;	gWeaponDescStatsRects[15].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[15].iBottom = SHIFT_Y + 71;
				gWeaponDescStatsRects[16].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[16].iTop = SHIFT_Y + 72;	gWeaponDescStatsRects[16].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[16].iBottom = SHIFT_Y + 83;
				gWeaponDescStatsRects[17].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[17].iTop = SHIFT_Y + 12;	gWeaponDescStatsRects[17].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[17].iBottom = SHIFT_Y + 23;	
				gWeaponDescStatsRects[18].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[18].iTop = SHIFT_Y + 24;	gWeaponDescStatsRects[18].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[18].iBottom = SHIFT_Y + 35;
				gWeaponDescStatsRects[19].iLeft = SHIFT_X + 407;	gWeaponDescStatsRects[19].iTop = SHIFT_Y + 84;	gWeaponDescStatsRects[19].iRight = SHIFT_X + 465;	gWeaponDescStatsRects[19].iBottom = SHIFT_Y + 95;

				gAmmoDescStatsRects[0].iLeft = SHIFT_X + 273;		gAmmoDescStatsRects[0].iTop = SHIFT_Y + 12;	gAmmoDescStatsRects[0].iRight = SHIFT_X + 331;	gAmmoDescStatsRects[0].iBottom = SHIFT_Y + 23;	// First Column
				gAmmoDescStatsRects[1].iLeft = SHIFT_X + 273;		gAmmoDescStatsRects[1].iTop = SHIFT_Y + 24;	gAmmoDescStatsRects[1].iRight = SHIFT_X + 331;	gAmmoDescStatsRects[1].iBottom = SHIFT_Y + 35;
				gAmmoDescStatsRects[2].iLeft = SHIFT_X + 273;		gAmmoDescStatsRects[2].iTop = SHIFT_Y + 36;	gAmmoDescStatsRects[2].iRight = SHIFT_X + 331;	gAmmoDescStatsRects[2].iBottom = SHIFT_Y + 47;
				gAmmoDescStatsRects[3].iLeft = SHIFT_X + 342;		gAmmoDescStatsRects[3].iTop = SHIFT_Y + 12;	gAmmoDescStatsRects[3].iRight = SHIFT_X + 364;	gAmmoDescStatsRects[3].iBottom = SHIFT_Y + 35;	// Second Column
				gAmmoDescStatsRects[4].iLeft = SHIFT_X + 369;		gAmmoDescStatsRects[4].iTop = SHIFT_Y + 12;	gAmmoDescStatsRects[4].iRight = SHIFT_X + 391;	gAmmoDescStatsRects[4].iBottom = SHIFT_Y + 35;
				gAmmoDescStatsRects[5].iLeft = SHIFT_X + 342;		gAmmoDescStatsRects[5].iTop = SHIFT_Y + 36;	gAmmoDescStatsRects[5].iRight = SHIFT_X + 364;	gAmmoDescStatsRects[5].iBottom = SHIFT_Y + 59;
				gAmmoDescStatsRects[6].iLeft = SHIFT_X + 369;		gAmmoDescStatsRects[6].iTop = SHIFT_Y + 36;	gAmmoDescStatsRects[6].iRight = SHIFT_X + 391;	gAmmoDescStatsRects[6].iBottom = SHIFT_Y + 59;
				gAmmoDescStatsRects[7].iLeft = SHIFT_X + 342;		gAmmoDescStatsRects[7].iTop = SHIFT_Y + 60;	gAmmoDescStatsRects[7].iRight = SHIFT_X + 364;	gAmmoDescStatsRects[7].iBottom = SHIFT_Y + 83;
				gAmmoDescStatsRects[8].iLeft = SHIFT_X + 407;		gAmmoDescStatsRects[8].iTop = SHIFT_Y + 12;	gAmmoDescStatsRects[8].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[8].iBottom = SHIFT_Y + 23;	// Third Column
				gAmmoDescStatsRects[9].iLeft = SHIFT_X + 407;		gAmmoDescStatsRects[9].iTop = SHIFT_Y + 24;	gAmmoDescStatsRects[9].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[9].iBottom = SHIFT_Y + 35;
				gAmmoDescStatsRects[10].iLeft = SHIFT_X + 407;	gAmmoDescStatsRects[10].iTop = SHIFT_Y + 36;	gAmmoDescStatsRects[10].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[10].iBottom = SHIFT_Y + 47;
				gAmmoDescStatsRects[11].iLeft = SHIFT_X + 407;	gAmmoDescStatsRects[11].iTop = SHIFT_Y + 48;	gAmmoDescStatsRects[11].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[11].iBottom = SHIFT_Y + 59;
				gAmmoDescStatsRects[12].iLeft = SHIFT_X + 407;	gAmmoDescStatsRects[12].iTop = SHIFT_Y + 60;	gAmmoDescStatsRects[12].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[12].iBottom = SHIFT_Y + 71;
				gAmmoDescStatsRects[13].iLeft = SHIFT_X + 407;	gAmmoDescStatsRects[13].iTop = SHIFT_Y + 72;	gAmmoDescStatsRects[13].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[13].iBottom = SHIFT_Y + 83;
				gAmmoDescStatsRects[14].iLeft = SHIFT_X + 407;	gAmmoDescStatsRects[14].iTop = SHIFT_Y + 84;	gAmmoDescStatsRects[14].iRight = SHIFT_X + 465;	gAmmoDescStatsRects[14].iBottom = SHIFT_Y + 95;	// Placeholders
				gAmmoDescStatsRects[15].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[15].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[15].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[15].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[16].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[16].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[16].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[16].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[17].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[17].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[17].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[17].iBottom = SHIFT_Y + 1;
				gAmmoDescStatsRects[18].iLeft = SHIFT_X + 0;		gAmmoDescStatsRects[18].iTop = SHIFT_Y + 0;	gAmmoDescStatsRects[18].iRight = SHIFT_X + 1;		gAmmoDescStatsRects[18].iBottom = SHIFT_Y + 1;
				...
				gArmorDescStatsRects[0].iLeft = SHIFT_X + 273;	gArmorDescStatsRects[0].iTop = SHIFT_Y + 12;		gArmorDescStatsRects[0].iRight = SHIFT_X + 331;	gArmorDescStatsRects[0].iBottom = SHIFT_Y + 23;	// First Column
				gArmorDescStatsRects[1].iLeft = SHIFT_X + 273;	gArmorDescStatsRects[1].iTop = SHIFT_Y + 24;		gArmorDescStatsRects[1].iRight = SHIFT_X + 331;	gArmorDescStatsRects[1].iBottom = SHIFT_Y + 35;
				gArmorDescStatsRects[2].iLeft = SHIFT_X + 273;	gArmorDescStatsRects[2].iTop = SHIFT_Y + 36;		gArmorDescStatsRects[2].iRight = SHIFT_X + 331;	gArmorDescStatsRects[2].iBottom = SHIFT_Y + 47;
				gArmorDescStatsRects[3].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[3].iTop = SHIFT_Y + 12;		gArmorDescStatsRects[3].iRight = SHIFT_X + 398;	gArmorDescStatsRects[3].iBottom = SHIFT_Y + 23;	// Second Column
				gArmorDescStatsRects[4].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[4].iTop = SHIFT_Y + 24;		gArmorDescStatsRects[4].iRight = SHIFT_X + 398;	gArmorDescStatsRects[4].iBottom = SHIFT_Y + 35;
				gArmorDescStatsRects[5].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[5].iTop = SHIFT_Y + 36;		gArmorDescStatsRects[5].iRight = SHIFT_X + 398;	gArmorDescStatsRects[5].iBottom = SHIFT_Y + 47;
				gArmorDescStatsRects[6].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[6].iTop = SHIFT_Y + 48;		gArmorDescStatsRects[6].iRight = SHIFT_X + 398;	gArmorDescStatsRects[6].iBottom = SHIFT_Y + 59;
				gArmorDescStatsRects[7].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[7].iTop = SHIFT_Y + 50;		gArmorDescStatsRects[7].iRight = SHIFT_X + 398;	gArmorDescStatsRects[7].iBottom = SHIFT_Y + 71;
				gArmorDescStatsRects[8].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[8].iTop = SHIFT_Y + 62;		gArmorDescStatsRects[8].iRight = SHIFT_X + 398;	gArmorDescStatsRects[8].iBottom = SHIFT_Y + 83;
				gArmorDescStatsRects[9].iLeft = SHIFT_X + 340;	gArmorDescStatsRects[9].iTop = SHIFT_Y + 74;		gArmorDescStatsRects[9].iRight = SHIFT_X + 398;	gArmorDescStatsRects[9].iBottom = SHIFT_Y + 95;
				gArmorDescStatsRects[10].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[10].iTop = SHIFT_Y + 12;		gArmorDescStatsRects[10].iRight = SHIFT_X + 465;	gArmorDescStatsRects[10].iBottom = SHIFT_Y + 23;	// Third Column
				gArmorDescStatsRects[11].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[11].iTop = SHIFT_Y + 24;		gArmorDescStatsRects[11].iRight = SHIFT_X + 465;	gArmorDescStatsRects[11].iBottom = SHIFT_Y + 35;
				gArmorDescStatsRects[12].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[12].iTop = SHIFT_Y + 36;		gArmorDescStatsRects[12].iRight = SHIFT_X + 465;	gArmorDescStatsRects[12].iBottom = SHIFT_Y + 47;
				gArmorDescStatsRects[13].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[13].iTop = SHIFT_Y + 48;		gArmorDescStatsRects[13].iRight = SHIFT_X + 465;	gArmorDescStatsRects[13].iBottom = SHIFT_Y + 59;
				gArmorDescStatsRects[14].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[14].iTop = SHIFT_Y + 60;		gArmorDescStatsRects[14].iRight = SHIFT_X + 465;	gArmorDescStatsRects[14].iBottom = SHIFT_Y + 71;	
				gArmorDescStatsRects[15].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[15].iTop = SHIFT_Y + 72;		gArmorDescStatsRects[15].iRight = SHIFT_X + 465;	gArmorDescStatsRects[15].iBottom = SHIFT_Y + 83;
				gArmorDescStatsRects[16].iLeft = SHIFT_X + 407;	gArmorDescStatsRects[16].iTop = SHIFT_Y + 84;		gArmorDescStatsRects[16].iRight = SHIFT_X + 465;	gArmorDescStatsRects[16].iBottom = SHIFT_Y + 95;
				gArmorDescStatsRects[17].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[17].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[17].iRight = SHIFT_X + 1;	gArmorDescStatsRects[17].iBottom = SHIFT_Y + 1;	// Placeholders
				gArmorDescStatsRects[18].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[18].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[18].iRight = SHIFT_X + 1;	gArmorDescStatsRects[18].iBottom = SHIFT_Y + 1;
				gArmorDescStatsRects[19].iLeft = SHIFT_X + 0;		gArmorDescStatsRects[19].iTop = SHIFT_Y + 0;		gArmorDescStatsRects[19].iRight = SHIFT_X + 1;	gArmorDescStatsRects[19].iBottom = SHIFT_Y + 1;

				gExplosiveDescStatsRects[0].iLeft = SHIFT_X + 273;	gExplosiveDescStatsRects[0].iTop = SHIFT_Y + 12;	gExplosiveDescStatsRects[0].iRight = SHIFT_X + 331;	gExplosiveDescStatsRects[0].iBottom = SHIFT_Y + 23;	// First Column
				gExplosiveDescStatsRects[1].iLeft = SHIFT_X + 273;	gExplosiveDescStatsRects[1].iTop = SHIFT_Y + 24;	gExplosiveDescStatsRects[1].iRight = SHIFT_X + 331;	gExplosiveDescStatsRects[1].iBottom = SHIFT_Y + 35;
				gExplosiveDescStatsRects[2].iLeft = SHIFT_X + 273;	gExplosiveDescStatsRects[2].iTop = SHIFT_Y + 36;	gExplosiveDescStatsRects[2].iRight = SHIFT_X + 331;	gExplosiveDescStatsRects[2].iBottom = SHIFT_Y + 47;
				gExplosiveDescStatsRects[3].iLeft = SHIFT_X + 273;	gExplosiveDescStatsRects[3].iTop = SHIFT_Y + 48;	gExplosiveDescStatsRects[3].iRight = SHIFT_X + 331;	gExplosiveDescStatsRects[3].iBottom = SHIFT_Y + 59;
				gExplosiveDescStatsRects[4].iLeft = SHIFT_X + 358;	gExplosiveDescStatsRects[4].iTop = SHIFT_Y + 12;	gExplosiveDescStatsRects[4].iRight = SHIFT_X + 374;	gExplosiveDescStatsRects[4].iBottom = SHIFT_Y + 47;	// Second Column
				gExplosiveDescStatsRects[5].iLeft = SHIFT_X + 342;	gExplosiveDescStatsRects[5].iTop = SHIFT_Y + 12;	gExplosiveDescStatsRects[5].iRight = SHIFT_X + 358;	gExplosiveDescStatsRects[5].iBottom = SHIFT_Y + 47;
				gExplosiveDescStatsRects[6].iLeft = SHIFT_X + 376;	gExplosiveDescStatsRects[6].iTop = SHIFT_Y + 12;	gExplosiveDescStatsRects[6].iRight = SHIFT_X + 395;	gExplosiveDescStatsRects[6].iBottom = SHIFT_Y + 47;
				gExplosiveDescStatsRects[7].iLeft = SHIFT_X + 341;	gExplosiveDescStatsRects[7].iTop = SHIFT_Y + 60;	gExplosiveDescStatsRects[7].iRight = SHIFT_X + 465;	gExplosiveDescStatsRects[7].iBottom = SHIFT_Y + 71;
				gExplosiveDescStatsRects[8].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[8].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[8].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[8].iBottom = SHIFT_Y + 1;	// Placeholders
				gExplosiveDescStatsRects[9].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[9].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[9].iRight = SHIFT_X + 1;		gExplosiveDescStatsRects[9].iBottom = SHIFT_Y + 1;
				gExplosiveDescStatsRects[10].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[10].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[10].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[10].iBottom = SHIFT_Y + 1;
				gExplosiveDescStatsRects[11].iLeft = SHIFT_X + 0;		gExplosiveDescStatsRects[11].iTop = SHIFT_Y + 0;	gExplosiveDescStatsRects[11].iRight = SHIFT_X + 1;	gExplosiveDescStatsRects[11].iBottom = SHIFT_Y + 1;
				...
				gMiscItemDescStatsRects[0].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[0].iTop = SHIFT_Y + 12;	gMiscItemDescStatsRects[0].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[0].iBottom = SHIFT_Y + 23; // Column 1
				gMiscItemDescStatsRects[1].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[1].iTop = SHIFT_Y + 24;	gMiscItemDescStatsRects[1].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[1].iBottom = SHIFT_Y + 35;
				gMiscItemDescStatsRects[2].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[2].iTop = SHIFT_Y + 36;	gMiscItemDescStatsRects[2].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[2].iBottom = SHIFT_Y + 47;
				gMiscItemDescStatsRects[3].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[3].iTop = SHIFT_Y + 48;	gMiscItemDescStatsRects[3].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[3].iBottom = SHIFT_Y + 59;
				gMiscItemDescStatsRects[4].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[4].iTop = SHIFT_Y + 60;	gMiscItemDescStatsRects[4].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[4].iBottom = SHIFT_Y + 71;
				gMiscItemDescStatsRects[5].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[5].iTop = SHIFT_Y + 72;	gMiscItemDescStatsRects[5].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[5].iBottom = SHIFT_Y + 83;
				gMiscItemDescStatsRects[6].iLeft = SHIFT_X + 273;		gMiscItemDescStatsRects[6].iTop = SHIFT_Y + 84;	gMiscItemDescStatsRects[6].iRight = SHIFT_X + 370;	gMiscItemDescStatsRects[6].iBottom = SHIFT_Y + 95;
				gMiscItemDescStatsRects[7].iLeft = SHIFT_X + 374;		gMiscItemDescStatsRects[7].iTop = SHIFT_Y + 12;	gMiscItemDescStatsRects[7].iRight = SHIFT_X + 471;	gMiscItemDescStatsRects[7].iBottom = SHIFT_Y + 23; // Column Two
				gMiscItemDescStatsRects[8].iLeft = SHIFT_X + 374;		gMiscItemDescStatsRects[8].iTop = SHIFT_Y + 24;	gMiscItemDescStatsRects[8].iRight = SHIFT_X + 471;	gMiscItemDescStatsRects[8].iBottom = SHIFT_Y + 35;
				gMiscItemDescStatsRects[9].iLeft = SHIFT_X + 374;		gMiscItemDescStatsRects[9].iTop = SHIFT_Y + 36;	gMiscItemDescStatsRects[9].iRight = SHIFT_X + 471;	gMiscItemDescStatsRects[9].iBottom = SHIFT_Y + 47;
				gMiscItemDescStatsRects[10].iLeft = SHIFT_X + 374;		gMiscItemDescStatsRects[10].iTop = SHIFT_Y + 48;	gMiscItemDescStatsRects[10].iRight = SHIFT_X + 471;	gMiscItemDescStatsRects[10].iBottom = SHIFT_Y + 59;
				gMiscItemDescStatsRects[11].iLeft = SHIFT_X + 374;		gMiscItemDescStatsRects[11].iTop = SHIFT_Y + 60;	gMiscItemDescStatsRects[11].iRight = SHIFT_X + 471;	gMiscItemDescStatsRects[11].iBottom = SHIFT_Y + 71;
				gMiscItemDescStatsRects[12].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[12].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[12].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[12].iBottom = SHIFT_Y + 1;	// Placeholders
				gMiscItemDescStatsRects[13].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[13].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[13].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[13].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[14].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[14].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[14].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[14].iBottom = SHIFT_Y + 1;
				gMiscItemDescStatsRects[15].iLeft = SHIFT_X + 0;		gMiscItemDescStatsRects[15].iTop = SHIFT_Y + 0;	gMiscItemDescStatsRects[15].iRight = SHIFT_X + 1;		gMiscItemDescStatsRects[15].iBottom = SHIFT_Y + 1;
...
{	
	...
	{	
		...
		if(gGameExternalOptions.fNewAttachmentSystem && !pObject->usAttachmentSlotIndexVector.empty() && UseNASDesc(pObject))
		{
			...
			for (UINT8 x = 0; x < pObject->usAttachmentSlotIndexVector.size(); x++){
				...
				if(AttachmentSlots[pObject->usAttachmentSlotIndexVector[x]].fBigSlot){
					SetupItemDescAttachmentsXY(x, AttachmentSlots[pObject->usAttachmentSlotIndexVector[x]].usDescPanelPosX, AttachmentSlots[pObject->usAttachmentSlotIndexVector[x]].usDescPanelPosY, SM_INV_SLOT_HEIGHT, ATTACH_SLOT_BIG_WIDTH, INV_BAR_DX-9, INV_BAR_DY);
				} else {
					SetupItemDescAttachmentsXY(x, AttachmentSlots[pObject->usAttachmentSlotIndexVector[x]].usDescPanelPosX, AttachmentSlots[pObject->usAttachmentSlotIndexVector[x]].usDescPanelPosY, SM_INV_SLOT_HEIGHT, ATTACH_SLOT_WIDTH, INV_BAR_DX-9, INV_BAR_DY);
				}
			}
		}
	...
	if(gGameExternalOptions.fNewAttachmentSystem){
		...
		if(UsingEDBSystem() > 0)
		{
			if( guiCurrentScreen == MAP_SCREEN )
			{
				gWeaponStats[0].sX = 52 + SHIFT_X;	gWeaponStats[0].sY = 98 + SHIFT_Y;	gWeaponStats[0].sValDx = 76;	// 0) STATUS
				gWeaponStats[1].sX = 52 + SHIFT_X;	gWeaponStats[1].sY = 108 + SHIFT_Y;	gWeaponStats[1].sValDx = 76;	// 1) WEIGHT
				// Labels and Values
				gWeaponStats[2].sX = 47 + SHIFT_X;	gWeaponStats[2].sY = 124 + SHIFT_Y;	gWeaponStats[2].sValDx = 30;	// 2) COL 1; ROW 1
				gWeaponStats[3].sX = 47 + SHIFT_X;	gWeaponStats[3].sY = 136 + SHIFT_Y;	gWeaponStats[3].sValDx = 30;	// 3) COL 1; ROW 2
				gWeaponStats[4].sX = 47 + SHIFT_X;	gWeaponStats[4].sY = 148 + SHIFT_Y;	gWeaponStats[4].sValDx = 30;	// 4) COL 1; ROW 3
				gWeaponStats[5].sX = 47 + SHIFT_X;	gWeaponStats[5].sY = 160 + SHIFT_Y;	gWeaponStats[5].sValDx = 30;	// 5) COL 1; ROW 4
				gWeaponStats[6].sX = 47 + SHIFT_X;	gWeaponStats[6].sY = 172 + SHIFT_Y;	gWeaponStats[6].sValDx = 30;	// 6) COL 1; ROW 5
				gWeaponStats[7].sX = 47 + SHIFT_X;	gWeaponStats[7].sY = 184 + SHIFT_Y;	gWeaponStats[7].sValDx = 30;	// 7) COL 1; ROW 6
				gWeaponStats[8].sX = 47 + SHIFT_X;	gWeaponStats[8].sY = 196 + SHIFT_Y;	gWeaponStats[8].sValDx = 30;	// 8) COL 1; ROW 7
				gWeaponStats[9].sX = 112 + SHIFT_X;	gWeaponStats[9].sY = 124 + SHIFT_Y;	gWeaponStats[9].sValDx = 29;	// 9) COL 2; ROW 1
				gWeaponStats[10].sX = 112 + SHIFT_X;	gWeaponStats[10].sY = 136 + SHIFT_Y;	gWeaponStats[10].sValDx = 29;	// 10) COL 2; ROW 2
				gWeaponStats[11].sX = 112 + SHIFT_X;	gWeaponStats[11].sY = 148 + SHIFT_Y;	gWeaponStats[11].sValDx = 29;	// 11) COL 2; ROW 3
				gWeaponStats[12].sX = 112 + SHIFT_X;	gWeaponStats[12].sY = 160 + SHIFT_Y;	gWeaponStats[12].sValDx = 29;	// 12) COL 2; ROW 4
				gWeaponStats[13].sX = 112 + SHIFT_X;	gWeaponStats[13].sY = 172 + SHIFT_Y;	gWeaponStats[13].sValDx = 29;	// 13) COL 2; ROW 5
				gWeaponStats[14].sX = 112 + SHIFT_X;	gWeaponStats[14].sY = 184 + SHIFT_Y;	gWeaponStats[14].sValDx = 29;	// 14) COL 2; ROW 6
				gWeaponStats[15].sX = 112 + SHIFT_X;	gWeaponStats[15].sY = 196 + SHIFT_Y;	gWeaponStats[15].sValDx = 29;	// 15) COL 2; ROW 7
				gWeaponStats[16].sX = 174 + SHIFT_X;	gWeaponStats[16].sY = 124 + SHIFT_Y;	gWeaponStats[16].sValDx = 30;	// 16) COL 3; ROW 1
				gWeaponStats[17].sX = 174 + SHIFT_X;	gWeaponStats[17].sY = 136 + SHIFT_Y;	gWeaponStats[17].sValDx = 30;	// 17) COL 3; ROW 2
				gWeaponStats[18].sX = 174 + SHIFT_X;	gWeaponStats[18].sY = 148 + SHIFT_Y;	gWeaponStats[18].sValDx = 30;	// 18) COL 3; ROW 3
				gWeaponStats[19].sX = 174 + SHIFT_X;	gWeaponStats[19].sY = 160 + SHIFT_Y;	gWeaponStats[19].sValDx = 30;	// 19) COL 3; ROW 4
				gWeaponStats[20].sX = 174 + SHIFT_X;	gWeaponStats[20].sY = 172 + SHIFT_Y;	gWeaponStats[20].sValDx = 30;	// 20) COL 3; ROW 5
				gWeaponStats[21].sX = 174 + SHIFT_X;	gWeaponStats[21].sY = 184 + SHIFT_Y;	gWeaponStats[21].sValDx = 30;	// 21) COL 3; ROW 6
				gWeaponStats[22].sX = 174 + SHIFT_X;	gWeaponStats[22].sY = 196 + SHIFT_Y;	gWeaponStats[22].sValDx = 30;	// 22) COL 3; ROW 7
				// EQUALS signs
				gWeaponStats[23].sX = 79 + SHIFT_X;	gWeaponStats[23].sY = 124 + SHIFT_Y;	gWeaponStats[23].sValDx = 0;	// 23) COL 1; ROW 1
				gWeaponStats[24].sX = 79 + SHIFT_X;	gWeaponStats[24].sY = 136 + SHIFT_Y;	gWeaponStats[24].sValDx = 0;	// 24) COL 1; ROW 2
				gWeaponStats[25].sX = 79 + SHIFT_X;	gWeaponStats[25].sY = 148 + SHIFT_Y;	gWeaponStats[25].sValDx = 0;	// 25) COL 1; ROW 3
				gWeaponStats[26].sX = 79 + SHIFT_X;	gWeaponStats[26].sY = 160 + SHIFT_Y;	gWeaponStats[26].sValDx = 0;	// 26) COL 1; ROW 4
				gWeaponStats[27].sX = 79 + SHIFT_X;	gWeaponStats[27].sY = 172 + SHIFT_Y;	gWeaponStats[27].sValDx = 0;	// 27) COL 1; ROW 5
				gWeaponStats[28].sX = 79 + SHIFT_X;	gWeaponStats[28].sY = 184 + SHIFT_Y;	gWeaponStats[28].sValDx = 0;	// 28) COL 1; ROW 6
				gWeaponStats[29].sX = 79 + SHIFT_X;	gWeaponStats[29].sY = 196 + SHIFT_Y;	gWeaponStats[29].sValDx = 0;	// 29) COL 1; ROW 7
				gWeaponStats[30].sX = 145 + SHIFT_X;	gWeaponStats[30].sY = 124 + SHIFT_Y;	gWeaponStats[30].sValDx = 0;	// 30) COL 2; ROW 1
				gWeaponStats[31].sX = 145 + SHIFT_X;	gWeaponStats[31].sY = 136 + SHIFT_Y;	gWeaponStats[31].sValDx = 0;	// 31) COL 2; ROW 2
				gWeaponStats[32].sX = 145 + SHIFT_X;	gWeaponStats[32].sY = 148 + SHIFT_Y;	gWeaponStats[32].sValDx = 0;	// 32) COL 2; ROW 3
				gWeaponStats[33].sX = 145 + SHIFT_X;	gWeaponStats[33].sY = 160 + SHIFT_Y;	gWeaponStats[33].sValDx = 0;	// 33) COL 2; ROW 4
				gWeaponStats[34].sX = 145 + SHIFT_X;	gWeaponStats[34].sY = 172 + SHIFT_Y;	gWeaponStats[34].sValDx = 0;	// 34) COL 2; ROW 5
				gWeaponStats[35].sX = 145 + SHIFT_X;	gWeaponStats[35].sY = 184 + SHIFT_Y;	gWeaponStats[35].sValDx = 0;	// 35) COL 2; ROW 6
				gWeaponStats[36].sX = 145 + SHIFT_X;	gWeaponStats[36].sY = 196 + SHIFT_Y;	gWeaponStats[36].sValDx = 0;	// 36) COL 2; ROW 7
				gWeaponStats[37].sX = 206 + SHIFT_X;	gWeaponStats[37].sY = 124 + SHIFT_Y;	gWeaponStats[37].sValDx = 0;	// 37) COL 3; ROW 1
				gWeaponStats[38].sX = 206 + SHIFT_X;	gWeaponStats[38].sY = 136 + SHIFT_Y;	gWeaponStats[38].sValDx = 0;	// 38) COL 3; ROW 2
				gWeaponStats[39].sX = 206 + SHIFT_X;	gWeaponStats[39].sY = 148 + SHIFT_Y;	gWeaponStats[39].sValDx = 0;	// 39) COL 3; ROW 3
				gWeaponStats[40].sX = 206 + SHIFT_X;	gWeaponStats[40].sY = 160 + SHIFT_Y;	gWeaponStats[40].sValDx = 0;	// 40) COL 3; ROW 4
				gWeaponStats[41].sX = 206 + SHIFT_X;	gWeaponStats[41].sY = 172 + SHIFT_Y;	gWeaponStats[41].sValDx = 0;	// 41) COL 3; ROW 5
				gWeaponStats[42].sX = 206 + SHIFT_X;	gWeaponStats[42].sY = 184 + SHIFT_Y;	gWeaponStats[42].sValDx = 0;	// 42) COL 3; ROW 6
				gWeaponStats[43].sX = 206 + SHIFT_X;	gWeaponStats[43].sY = 196 + SHIFT_Y;	gWeaponStats[43].sValDx = 0;	// 43) COL 3; ROW 7
				// Nonregular locations for explosive data (COL 2; ROW 3)
				gWeaponStats[44].sX = 116 + SHIFT_X;	gWeaponStats[44].sY = 148 + SHIFT_Y;	gWeaponStats[44].sValDx = 0;	// 44) COL 2; ROW 3; LOC 1
				gWeaponStats[45].sX = 134 + SHIFT_X;	gWeaponStats[45].sY = 148 + SHIFT_Y;	gWeaponStats[45].sValDx = 0;	// 45) COL 2; ROW 3; LOC 2
				gWeaponStats[46].sX = 150 + SHIFT_X;	gWeaponStats[46].sY = 148 + SHIFT_Y;	gWeaponStats[46].sValDx = 0;	// 46) COL 2; ROW 3; LOC 3

				gMoneyStats[0].sX = 51 + SHIFT_X;	gMoneyStats[0].sY = 124 + SHIFT_Y;	gMoneyStats[0].sValDx = 45;	// Money
				gMoneyStats[1].sX = 61 + SHIFT_X;	gMoneyStats[1].sY = 136 + SHIFT_Y;	gMoneyStats[1].sValDx = 65;	// Remaining
				gMoneyStats[2].sX = 51 + SHIFT_X;	gMoneyStats[2].sY = 172 + SHIFT_Y;	gMoneyStats[2].sValDx = 45;	// Money
				gMoneyStats[3].sX = 61 + SHIFT_X;	gMoneyStats[3].sY = 184 + SHIFT_Y;	gMoneyStats[3].sValDx = 65;	// Removing
				gMoneyStats[4].sX = 47 + SHIFT_X;	gMoneyStats[4].sY = 148 + SHIFT_Y;	gMoneyStats[4].sValDx = 62;	// AMT remaining
				gMoneyStats[5].sX = 47 + SHIFT_X;	gMoneyStats[5].sY = 196 + SHIFT_Y;	gMoneyStats[5].sValDx = 62;	// AMT removing

				gItemDescProsConsRects[0].iLeft = 14 + SHIFT_X;	gItemDescProsConsRects[0].iTop = 291 + SHIFT_Y;	gItemDescProsConsRects[0].iRight = 250 + SHIFT_X;	gItemDescProsConsRects[0].iBottom = 298 + SHIFT_Y;
				gItemDescProsConsRects[1].iLeft = 14 + SHIFT_X;	gItemDescProsConsRects[1].iTop = 299 + SHIFT_Y;	gItemDescProsConsRects[1].iRight = 250 + SHIFT_X;	gItemDescProsConsRects[1].iBottom = 306 + SHIFT_Y;
			...
			else
			{
				...
				{
					gWeaponStats[0].sX = SHIFT_X +  205;	gWeaponStats[0].sY = SHIFT_Y +  14;	gWeaponStats[0].sValDx = 91;	// 0) STATUS
					gWeaponStats[1].sX = SHIFT_X +  205;	gWeaponStats[1].sY = SHIFT_Y +  24;	gWeaponStats[1].sValDx = 91;	// 1) WEIGHT
					// Labels and Values
					gWeaponStats[2].sX = SHIFT_X +  203;	gWeaponStats[2].sY = SHIFT_Y +  44;	gWeaponStats[2].sValDx = 30;	// 2) COL 1; ROW 1
					gWeaponStats[3].sX = SHIFT_X +  203;	gWeaponStats[3].sY = SHIFT_Y +  56;	gWeaponStats[3].sValDx = 30;	// 3) COL 1; ROW 2
					gWeaponStats[4].sX = SHIFT_X +  203;	gWeaponStats[4].sY = SHIFT_Y +  68;	gWeaponStats[4].sValDx = 30;	// 4) COL 1; ROW 3
					gWeaponStats[5].sX = SHIFT_X +  203;	gWeaponStats[5].sY = SHIFT_Y +  80;	gWeaponStats[5].sValDx = 30;	// 5) COL 1; ROW 4
					gWeaponStats[6].sX = SHIFT_X +  203;	gWeaponStats[6].sY = SHIFT_Y +  92;	gWeaponStats[6].sValDx = 30;	// 6) COL 1; ROW 5
					gWeaponStats[7].sX = SHIFT_X +  203;	gWeaponStats[7].sY = SHIFT_Y +  104;	gWeaponStats[7].sValDx = 30;	// 7) COL 1; ROW 6
					gWeaponStats[8].sX = SHIFT_X +  203;	gWeaponStats[8].sY = SHIFT_Y +  116;	gWeaponStats[8].sValDx = 30;	// 8) COL 1; ROW 7
					gWeaponStats[9].sX = SHIFT_X +  268;	gWeaponStats[9].sY = SHIFT_Y +  44;	gWeaponStats[9].sValDx = 30;	// 9) COL 2; ROW 1
					gWeaponStats[10].sX = SHIFT_X +  268;	gWeaponStats[10].sY = SHIFT_Y +  56;	gWeaponStats[10].sValDx = 30;	// 10) COL 2; ROW 2
					gWeaponStats[11].sX = SHIFT_X +  268;	gWeaponStats[11].sY = SHIFT_Y +  68;	gWeaponStats[11].sValDx = 30;	// 11) COL 2; ROW 3
					gWeaponStats[12].sX = SHIFT_X +  268;	gWeaponStats[12].sY = SHIFT_Y +  80;	gWeaponStats[12].sValDx = 30;	// 12) COL 2; ROW 4
					gWeaponStats[13].sX = SHIFT_X +  268;	gWeaponStats[13].sY = SHIFT_Y +  92;	gWeaponStats[13].sValDx = 30;	// 13) COL 2; ROW 5
					gWeaponStats[14].sX = SHIFT_X +  268;	gWeaponStats[14].sY = SHIFT_Y +  104;	gWeaponStats[14].sValDx = 30;	// 14) COL 2; ROW 6
					gWeaponStats[15].sX = SHIFT_X +  268;	gWeaponStats[15].sY = SHIFT_Y +  116;	gWeaponStats[15].sValDx = 30;	// 15) COL 2; ROW 7
					gWeaponStats[16].sX = SHIFT_X +  203;	gWeaponStats[16].sY = SHIFT_Y +  136;	gWeaponStats[16].sValDx = 30;	// 16) COL 3; ROW 1
					gWeaponStats[17].sX = SHIFT_X +  203;	gWeaponStats[17].sY = SHIFT_Y +  160;	gWeaponStats[17].sValDx = 30;	// 17) COL 3; ROW 3
					gWeaponStats[18].sX = SHIFT_X +  268;	gWeaponStats[18].sY = SHIFT_Y +  136;	gWeaponStats[18].sValDx = 30;	// 18) COL 4; ROW 1
					gWeaponStats[19].sX = SHIFT_X +  268;	gWeaponStats[19].sY = SHIFT_Y +  148;	gWeaponStats[19].sValDx = 30;	// 19) COL 4; ROW 2
					gWeaponStats[20].sX = SHIFT_X +  268;	gWeaponStats[20].sY = SHIFT_Y +  160;	gWeaponStats[20].sValDx = 30;	// 20) COL 4; ROW 3
					gWeaponStats[21].sX = SHIFT_X +  268;	gWeaponStats[21].sY = SHIFT_Y +  172;	gWeaponStats[21].sValDx = 30;	// 21) COL 3; ROW 4
					gWeaponStats[22].sX = SHIFT_X +  203;	gWeaponStats[22].sY = SHIFT_Y +  172;	gWeaponStats[22].sValDx = 30;	// 22) COL 4; ROW 4

					// EQUALS signs
					gWeaponStats[23].sX = SHIFT_X +  235;	gWeaponStats[23].sY = SHIFT_Y +  44;	gWeaponStats[23].sValDx = 0;	// 23) COL 1; ROW 1
					gWeaponStats[24].sX = SHIFT_X +  235;	gWeaponStats[24].sY = SHIFT_Y +  56;	gWeaponStats[24].sValDx = 0;	// 24) COL 1; ROW 2
					gWeaponStats[25].sX = SHIFT_X +  235;	gWeaponStats[25].sY = SHIFT_Y +  68;	gWeaponStats[25].sValDx = 0;	// 25) COL 1; ROW 3
					gWeaponStats[26].sX = SHIFT_X +  235;	gWeaponStats[26].sY = SHIFT_Y +  80;	gWeaponStats[26].sValDx = 0;	// 26) COL 1; ROW 4
					gWeaponStats[27].sX = SHIFT_X +  235;	gWeaponStats[27].sY = SHIFT_Y +  92;	gWeaponStats[27].sValDx = 0;	// 27) COL 1; ROW 5
					gWeaponStats[28].sX = SHIFT_X +  235;	gWeaponStats[28].sY = SHIFT_Y +  104;	gWeaponStats[28].sValDx = 0;	// 28) COL 1; ROW 6
					gWeaponStats[29].sX = SHIFT_X +  235;	gWeaponStats[29].sY = SHIFT_Y +  116;	gWeaponStats[29].sValDx = 0;	// 29) COL 1; ROW 7
					gWeaponStats[30].sX = SHIFT_X +  300;	gWeaponStats[30].sY = SHIFT_Y +  44;	gWeaponStats[30].sValDx = 0;	// 30) COL 2; ROW 1
					gWeaponStats[31].sX = SHIFT_X +  300;	gWeaponStats[31].sY = SHIFT_Y +  56;	gWeaponStats[31].sValDx = 0;	// 31) COL 2; ROW 2
					gWeaponStats[32].sX = SHIFT_X +  300;	gWeaponStats[32].sY = SHIFT_Y +  68;	gWeaponStats[32].sValDx = 0;	// 32) COL 2; ROW 3
					gWeaponStats[33].sX = SHIFT_X +  300;	gWeaponStats[33].sY = SHIFT_Y +  80;	gWeaponStats[33].sValDx = 0;	// 33) COL 2; ROW 4
					gWeaponStats[34].sX = SHIFT_X +  300;	gWeaponStats[34].sY = SHIFT_Y +  92;	gWeaponStats[34].sValDx = 0;	// 34) COL 2; ROW 5
					gWeaponStats[35].sX = SHIFT_X +  300;	gWeaponStats[35].sY = SHIFT_Y +  104;	gWeaponStats[35].sValDx = 0;	// 35) COL 2; ROW 6
					gWeaponStats[36].sX = SHIFT_X +  300;	gWeaponStats[36].sY = SHIFT_Y +  116;	gWeaponStats[36].sValDx = 0;	// 36) COL 2; ROW 7
					gWeaponStats[37].sX = SHIFT_X +  235;	gWeaponStats[37].sY = SHIFT_Y +  136;	gWeaponStats[37].sValDx = 0;	// 37) COL 3; ROW 1
					gWeaponStats[38].sX = SHIFT_X +  235;	gWeaponStats[38].sY = SHIFT_Y +  160;	gWeaponStats[38].sValDx = 0;	// 38) COL 3; ROW 3
					gWeaponStats[39].sX = SHIFT_X +  300;	gWeaponStats[39].sY = SHIFT_Y +  136;	gWeaponStats[39].sValDx = 0;	// 39) COL 4; ROW 1
					gWeaponStats[40].sX = SHIFT_X +  300;	gWeaponStats[40].sY = SHIFT_Y +  148;	gWeaponStats[40].sValDx = 0;	// 40) COL 4; ROW 2
					gWeaponStats[41].sX = SHIFT_X +  300;	gWeaponStats[41].sY = SHIFT_Y +  160;	gWeaponStats[41].sValDx = 0;	// 41) COL 4; ROW 3
					gWeaponStats[42].sX = SHIFT_X +  300;	gWeaponStats[42].sY = SHIFT_Y +  172;	gWeaponStats[42].sValDx = 0;	// 42) COL 3; ROW 4
					gWeaponStats[43].sX = SHIFT_X +  235;	gWeaponStats[43].sY = SHIFT_Y +  172;	gWeaponStats[43].sValDx = 0;	// 43) COL 4; ROW 4
					// Nonregular locations for explosive radius values (COL 2; ROW 3)
					gWeaponStats[44].sX = SHIFT_X +  273;	gWeaponStats[44].sY = SHIFT_Y +  68;	gWeaponStats[44].sValDx = 0;	// 44) COL 2; ROW 3; LOC 1 - Starting Radius
					gWeaponStats[45].sX = SHIFT_X +  291;	gWeaponStats[45].sY = SHIFT_Y +  68;	gWeaponStats[45].sValDx = 0;	// 45) COL 2; ROW 3; LOC 2 - Single Radius
					gWeaponStats[46].sX = SHIFT_X +  307;	gWeaponStats[46].sY = SHIFT_Y +  68;	gWeaponStats[46].sValDx = 0;	// 46) COL 2; ROW 3; LOC 3 - Final Radius

					gMoneyStats[0].sX = SHIFT_X +  203;	gMoneyStats[0].sY = SHIFT_Y +  44;		gMoneyStats[0].sValDx = 45;		// Money
					gMoneyStats[1].sX = SHIFT_X +  213;	gMoneyStats[1].sY = SHIFT_Y +  56;		gMoneyStats[1].sValDx = 65;		// Remaining
					gMoneyStats[2].sX = SHIFT_X +  203;	gMoneyStats[2].sY = SHIFT_Y +  92;		gMoneyStats[2].sValDx = 45;		// Money
					gMoneyStats[3].sX = SHIFT_X +  213;	gMoneyStats[3].sY = SHIFT_Y +  104;	gMoneyStats[3].sValDx = 65;		// Removing
					gMoneyStats[4].sX = SHIFT_X +  203;	gMoneyStats[4].sY = SHIFT_Y +  56;		gMoneyStats[4].sValDx = 100;	// AMT remaining
					gMoneyStats[5].sX = SHIFT_X +  203;	gMoneyStats[5].sY = SHIFT_Y +  104;	gMoneyStats[5].sValDx = 100;	// AMT removing

					gItemDescProsConsRects[0].iLeft = SHIFT_X + 14;	gItemDescProsConsRects[0].iTop = SHIFT_Y + 169;	gItemDescProsConsRects[0].iRight = SHIFT_X + 188;	gItemDescProsConsRects[0].iBottom = SHIFT_Y + 176;
					gItemDescProsConsRects[1].iLeft = SHIFT_X + 14;	gItemDescProsConsRects[1].iTop = SHIFT_Y + 177;	gItemDescProsConsRects[1].iRight = SHIFT_X + 188;	gItemDescProsConsRects[1].iBottom = SHIFT_Y + 184;
				}
				if (UsingEDBSystem() == 2) // OIV EDB
				{
					gWeaponStats[0].sX = SHIFT_X +  202;	gWeaponStats[0].sY = SHIFT_Y +  16;	gWeaponStats[0].sValDx = 36;	// 0) STATUS
					gWeaponStats[1].sX = SHIFT_X +  202;	gWeaponStats[1].sY = SHIFT_Y +  64;	gWeaponStats[1].sValDx = 36;	// 1) WEIGHT
					// Labels and Values
					gWeaponStats[2].sX = SHIFT_X +  274;	gWeaponStats[2].sY = SHIFT_Y +  14;	gWeaponStats[2].sValDx = 30;	// 2) COL 1; ROW 1
					gWeaponStats[3].sX = SHIFT_X +  274;	gWeaponStats[3].sY = SHIFT_Y +  26;	gWeaponStats[3].sValDx = 30;	// 3) COL 1; ROW 2
					gWeaponStats[4].sX = SHIFT_X +  274;	gWeaponStats[4].sY = SHIFT_Y +  38;	gWeaponStats[4].sValDx = 30;	// 4) COL 1; ROW 3
					gWeaponStats[5].sX = SHIFT_X +  274;	gWeaponStats[5].sY = SHIFT_Y +  50;	gWeaponStats[5].sValDx = 30;	// 5) COL 1; ROW 4
					gWeaponStats[6].sX = SHIFT_X +  274;	gWeaponStats[6].sY = SHIFT_Y +  62;	gWeaponStats[6].sValDx = 30;	// 6) COL 1; ROW 5
					gWeaponStats[7].sX = SHIFT_X +  274;	gWeaponStats[7].sY = SHIFT_Y +  74;	gWeaponStats[7].sValDx = 30;	// 7) COL 1; ROW 6
					gWeaponStats[8].sX = SHIFT_X +  274;	gWeaponStats[8].sY = SHIFT_Y +  86;	gWeaponStats[8].sValDx = 30;	// 8) COL 1; ROW 7
					gWeaponStats[9].sX = SHIFT_X +  341;	gWeaponStats[9].sY = SHIFT_Y +  14;	gWeaponStats[9].sValDx = 30;	// 9) COL 2; ROW 1
					gWeaponStats[10].sX = SHIFT_X +  341;	gWeaponStats[10].sY = SHIFT_Y +  26;	gWeaponStats[10].sValDx = 30;	// 10) COL 2; ROW 2
					gWeaponStats[11].sX = SHIFT_X +  341;	gWeaponStats[11].sY = SHIFT_Y +  38;	gWeaponStats[11].sValDx = 30;	// 11) COL 2; ROW 3
					gWeaponStats[12].sX = SHIFT_X +  341;	gWeaponStats[12].sY = SHIFT_Y +  50;	gWeaponStats[12].sValDx = 30;	// 12) COL 2; ROW 4
					gWeaponStats[13].sX = SHIFT_X +  341;	gWeaponStats[13].sY = SHIFT_Y +  62;	gWeaponStats[13].sValDx = 30;	// 13) COL 2; ROW 5
					gWeaponStats[14].sX = SHIFT_X +  341;	gWeaponStats[14].sY = SHIFT_Y +  74;	gWeaponStats[14].sValDx = 30;	// 14) COL 2; ROW 6
					gWeaponStats[15].sX = SHIFT_X +  341;	gWeaponStats[15].sY = SHIFT_Y +  86;	gWeaponStats[15].sValDx = 30;	// 15) COL 2; ROW 7
					gWeaponStats[16].sX = SHIFT_X +  408;	gWeaponStats[16].sY = SHIFT_Y +  14;	gWeaponStats[16].sValDx = 30;	// 16) COL 3; ROW 1
					gWeaponStats[17].sX = SHIFT_X +  408;	gWeaponStats[17].sY = SHIFT_Y +  26;	gWeaponStats[17].sValDx = 30;	// 17) COL 3; ROW 2
					gWeaponStats[18].sX = SHIFT_X +  408;	gWeaponStats[18].sY = SHIFT_Y +  38;	gWeaponStats[18].sValDx = 30;	// 18) COL 3; ROW 3
					gWeaponStats[19].sX = SHIFT_X +  408;	gWeaponStats[19].sY = SHIFT_Y +  50;	gWeaponStats[19].sValDx = 30;	// 19) COL 3; ROW 4
					gWeaponStats[20].sX = SHIFT_X +  408;	gWeaponStats[20].sY = SHIFT_Y +  62;	gWeaponStats[20].sValDx = 30;	// 20) COL 3; ROW 5
					gWeaponStats[21].sX = SHIFT_X +  408;	gWeaponStats[21].sY = SHIFT_Y +  74;	gWeaponStats[21].sValDx = 30;	// 21) COL 3; ROW 6
					gWeaponStats[22].sX = SHIFT_X +  408;	gWeaponStats[22].sY = SHIFT_Y +  86;	gWeaponStats[22].sValDx = 30;	// 22) COL 3; ROW 7
					// EQUALS signs
					gWeaponStats[23].sX = SHIFT_X +  306;	gWeaponStats[23].sY = SHIFT_Y +  14;	gWeaponStats[23].sValDx = 0;	// 23) COL 1; ROW 1
					gWeaponStats[24].sX = SHIFT_X +  306;	gWeaponStats[24].sY = SHIFT_Y +  26;	gWeaponStats[24].sValDx = 0;	// 24) COL 1; ROW 2
					gWeaponStats[25].sX = SHIFT_X +  306;	gWeaponStats[25].sY = SHIFT_Y +  38;	gWeaponStats[25].sValDx = 0;	// 25) COL 1; ROW 3
					gWeaponStats[26].sX = SHIFT_X +  306;	gWeaponStats[26].sY = SHIFT_Y +  50;	gWeaponStats[26].sValDx = 0;	// 26) COL 1; ROW 4
					gWeaponStats[27].sX = SHIFT_X +  306;	gWeaponStats[27].sY = SHIFT_Y +  62;	gWeaponStats[27].sValDx = 0;	// 27) COL 1; ROW 5
					gWeaponStats[28].sX = SHIFT_X +  306;	gWeaponStats[28].sY = SHIFT_Y +  74;	gWeaponStats[28].sValDx = 0;	// 28) COL 1; ROW 6
					gWeaponStats[29].sX = SHIFT_X +  306;	gWeaponStats[29].sY = SHIFT_Y +  86;	gWeaponStats[29].sValDx = 0;	// 39) COL 1; ROW 7
					gWeaponStats[30].sX = SHIFT_X +  373;	gWeaponStats[30].sY = SHIFT_Y +  14;	gWeaponStats[30].sValDx = 0;	// 30) COL 2; ROW 1
					gWeaponStats[31].sX = SHIFT_X +  373;	gWeaponStats[31].sY = SHIFT_Y +  26;	gWeaponStats[31].sValDx = 0;	// 31) COL 2; ROW 2
					gWeaponStats[32].sX = SHIFT_X +  373;	gWeaponStats[32].sY = SHIFT_Y +  38;	gWeaponStats[32].sValDx = 0;	// 32) COL 2; ROW 3
					gWeaponStats[33].sX = SHIFT_X +  373;	gWeaponStats[33].sY = SHIFT_Y +  50;	gWeaponStats[33].sValDx = 0;	// 33) COL 2; ROW 4
					gWeaponStats[34].sX = SHIFT_X +  373;	gWeaponStats[34].sY = SHIFT_Y +  62;	gWeaponStats[34].sValDx = 0;	// 34) COL 2; ROW 5
					gWeaponStats[35].sX = SHIFT_X +  373;	gWeaponStats[35].sY = SHIFT_Y +  74;	gWeaponStats[35].sValDx = 0;	// 35) COL 2; ROW 6
					gWeaponStats[36].sX = SHIFT_X +  373;	gWeaponStats[36].sY = SHIFT_Y +  86;	gWeaponStats[36].sValDx = 0;	// 36) COL 2; ROW 7
					gWeaponStats[37].sX = SHIFT_X +  440;	gWeaponStats[37].sY = SHIFT_Y +  14;	gWeaponStats[37].sValDx = 0;	// 37) COL 3; ROW 1
					gWeaponStats[38].sX = SHIFT_X +  440;	gWeaponStats[38].sY = SHIFT_Y +  26;	gWeaponStats[38].sValDx = 0;	// 48) COL 3; ROW 2
					gWeaponStats[39].sX = SHIFT_X +  440;	gWeaponStats[39].sY = SHIFT_Y +  38;	gWeaponStats[39].sValDx = 0;	// 49) COL 3; ROW 3
					gWeaponStats[40].sX = SHIFT_X +  440;	gWeaponStats[40].sY = SHIFT_Y +  50;	gWeaponStats[40].sValDx = 0;	// 40) COL 3; ROW 4
					gWeaponStats[41].sX = SHIFT_X +  440;	gWeaponStats[41].sY = SHIFT_Y +  62;	gWeaponStats[41].sValDx = 0;	// 41) COL 3; ROW 5
					gWeaponStats[42].sX = SHIFT_X +  440;	gWeaponStats[42].sY = SHIFT_Y +  74;	gWeaponStats[42].sValDx = 0;	// 42) COL 3; ROW 6
					gWeaponStats[43].sX = SHIFT_X +  440;	gWeaponStats[43].sY = SHIFT_Y +  86;	gWeaponStats[43].sValDx = 0;	// 43) COL 3; ROW 7
					// Nonregular locations for explosive radius values (COL 2; ROW 3)
					gWeaponStats[44].sX = SHIFT_X +  345;	gWeaponStats[44].sY = SHIFT_Y +  38;	gWeaponStats[44].sValDx = 0;	// 44) COL 2; ROW 3; LOC 1 - Starting Radius
					gWeaponStats[45].sX = SHIFT_X +  362;	gWeaponStats[45].sY = SHIFT_Y +  38;	gWeaponStats[45].sValDx = 0;	// 45) COL 2; ROW 3; LOC 2 - Single Radius
					gWeaponStats[46].sX = SHIFT_X +  381;	gWeaponStats[46].sY = SHIFT_Y +  38;	gWeaponStats[46].sValDx = 0;	// 46) COL 2; ROW 3; LOC 3 - Final Radius

					gMoneyStats[0].sX = SHIFT_X +  202;	gMoneyStats[0].sY = SHIFT_Y +  14;		gMoneyStats[0].sValDx = 45;		// Money
					gMoneyStats[1].sX = SHIFT_X +  202;	gMoneyStats[1].sY = SHIFT_Y +  26;		gMoneyStats[1].sValDx = 65;		// Remaining
					gMoneyStats[2].sX = SHIFT_X +  202;	gMoneyStats[2].sY = SHIFT_Y +  62;		gMoneyStats[2].sValDx = 45;		// Money
					gMoneyStats[3].sX = SHIFT_X +  202;	gMoneyStats[3].sY = SHIFT_Y +  74;	gMoneyStats[3].sValDx = 65;		// Removing
					gMoneyStats[4].sX = SHIFT_X +  202;	gMoneyStats[4].sY = SHIFT_Y +  38;		gMoneyStats[4].sValDx = 100;	// AMT remaining
					gMoneyStats[5].sX = SHIFT_X +  202;	gMoneyStats[5].sY = SHIFT_Y +  86;	gMoneyStats[5].sValDx = 100;	// AMT removing

					gItemDescProsConsRects[0].iLeft = 433 + SHIFT_X;	gItemDescProsConsRects[0].iTop = 104 + SHIFT_Y;	gItemDescProsConsRects[0].iRight = 467 + SHIFT_X;	gItemDescProsConsRects[0].iBottom = 115 + SHIFT_Y;
					gItemDescProsConsRects[1].iLeft = 433 + SHIFT_X;	gItemDescProsConsRects[1].iTop = 116 + SHIFT_Y;	gItemDescProsConsRects[1].iRight = 467 + SHIFT_X;	gItemDescProsConsRects[1].iBottom = 127 + SHIFT_Y;
				}
			}
		}
		else
		{
			if(guiCurrentScreen ==MAP_SCREEN)
			{
				gWeaponStats[0].sX = SHIFT_X +  52;	gWeaponStats[0].sY = SHIFT_Y +  98;	gWeaponStats[0].sValDx = 89;	// 0) STATUS
				gWeaponStats[1].sX = SHIFT_X +  52;	gWeaponStats[1].sY = SHIFT_Y +  108;	gWeaponStats[1].sValDx = 89;	// 1) WEIGHT
				gWeaponStats[2].sX = SHIFT_X +  117;	gWeaponStats[2].sY = SHIFT_Y +  124;	gWeaponStats[2].sValDx = 21;	// 2) RANGE
				gWeaponStats[3].sX = SHIFT_X +  52;	gWeaponStats[3].sY = SHIFT_Y +  124;	gWeaponStats[3].sValDx = 30;	// 3) DAMAGE
				gWeaponStats[4].sX = SHIFT_X +  52;	gWeaponStats[4].sY = SHIFT_Y +  98;	gWeaponStats[4].sValDx = 80;
				gWeaponStats[5].sX = SHIFT_X +  52;	gWeaponStats[5].sY = SHIFT_Y +  135;	gWeaponStats[5].sValDx = 30;	// 5) AP
				gWeaponStats[6].sX = SHIFT_X +  117;	gWeaponStats[6].sY = SHIFT_Y +  135;	gWeaponStats[6].sValDx = 25;
				gWeaponStats[7].sX = SHIFT_X +  86;	gWeaponStats[7].sY = SHIFT_Y +  135;	gWeaponStats[7].sValDx = 0;	// 7) =
				gWeaponStats[8].sX = SHIFT_X +  145;	gWeaponStats[8].sY = SHIFT_Y +  135;	gWeaponStats[8].sValDx = 0;	// 8) =
				gWeaponStats[9].sX = SHIFT_X +  0;		gWeaponStats[9].sY = SHIFT_Y +  0;		gWeaponStats[9].sValDx = 0;
				gWeaponStats[10].sX = SHIFT_X +  0;	gWeaponStats[10].sY = SHIFT_Y +  0;	gWeaponStats[10].sValDx = 0;
				gWeaponStats[11].sX = SHIFT_X +  0;	gWeaponStats[11].sY = SHIFT_Y +  0;	gWeaponStats[11].sValDx = 0;
				gWeaponStats[12].sX = SHIFT_X +  0;	gWeaponStats[12].sY = SHIFT_Y +  0;	gWeaponStats[12].sValDx = 0;
				gWeaponStats[13].sX = SHIFT_X +  0;	gWeaponStats[13].sY = SHIFT_Y +  0;	gWeaponStats[13].sValDx = 0;
				gWeaponStats[14].sX = SHIFT_X +  0;	gWeaponStats[14].sY = SHIFT_Y +  0;	gWeaponStats[14].sValDx = 0;
				gWeaponStats[15].sX = SHIFT_X +  0;	gWeaponStats[15].sY = SHIFT_Y +  0;	gWeaponStats[15].sValDx = 0;
				gWeaponStats[16].sX = SHIFT_X +  0;	gWeaponStats[16].sY = SHIFT_Y +  0;	gWeaponStats[16].sValDx = 0;
				gWeaponStats[17].sX = SHIFT_X +  0;	gWeaponStats[17].sY = SHIFT_Y +  0;	gWeaponStats[17].sValDx = 0;
				gWeaponStats[18].sX = SHIFT_X +  0;	gWeaponStats[18].sY = SHIFT_Y +  0;	gWeaponStats[18].sValDx = 0;
				gWeaponStats[19].sX = SHIFT_X +  0;	gWeaponStats[19].sY = SHIFT_Y +  0;	gWeaponStats[19].sValDx = 0;
				gWeaponStats[20].sX = SHIFT_X +  0;	gWeaponStats[20].sY = SHIFT_Y +  0;	gWeaponStats[20].sValDx = 0;
				gWeaponStats[21].sX = SHIFT_X +  0;	gWeaponStats[21].sY = SHIFT_Y +  0;	gWeaponStats[21].sValDx = 0;
				gWeaponStats[22].sX = SHIFT_X +  0;	gWeaponStats[22].sY = SHIFT_Y +  0;	gWeaponStats[22].sValDx = 0;
				gWeaponStats[23].sX = SHIFT_X +  0;	gWeaponStats[23].sY = SHIFT_Y +  0;	gWeaponStats[23].sValDx = 0;
				gWeaponStats[24].sX = SHIFT_X +  0;	gWeaponStats[24].sY = SHIFT_Y +  0;	gWeaponStats[24].sValDx = 0;
				gWeaponStats[25].sX = SHIFT_X +  0;	gWeaponStats[25].sY = SHIFT_Y +  0;	gWeaponStats[25].sValDx = 0;
				gWeaponStats[26].sX = SHIFT_X +  0;	gWeaponStats[26].sY = SHIFT_Y +  0;	gWeaponStats[26].sValDx = 0;
				gWeaponStats[27].sX = SHIFT_X +  0;	gWeaponStats[27].sY = SHIFT_Y +  0;	gWeaponStats[27].sValDx = 0;
				gWeaponStats[28].sX = SHIFT_X +  0;	gWeaponStats[28].sY = SHIFT_Y +  0;	gWeaponStats[28].sValDx = 0;
				gWeaponStats[29].sX = SHIFT_X +  0;	gWeaponStats[29].sY = SHIFT_Y +  0;	gWeaponStats[29].sValDx = 0;
				gWeaponStats[30].sX = SHIFT_X +  0;	gWeaponStats[30].sY = SHIFT_Y +  0;	gWeaponStats[30].sValDx = 0;
				gWeaponStats[31].sX = SHIFT_X +  0;	gWeaponStats[31].sY = SHIFT_Y +  0;	gWeaponStats[31].sValDx = 0;
				gWeaponStats[32].sX = SHIFT_X +  0;	gWeaponStats[32].sY = SHIFT_Y +  0;	gWeaponStats[32].sValDx = 0;
				gWeaponStats[33].sX = SHIFT_X +  0;	gWeaponStats[33].sY = SHIFT_Y +  0;	gWeaponStats[33].sValDx = 0;
				gWeaponStats[34].sX = SHIFT_X +  0;	gWeaponStats[34].sY = SHIFT_Y +  0;	gWeaponStats[34].sValDx = 0;
				gWeaponStats[35].sX = SHIFT_X +  0;	gWeaponStats[35].sY = SHIFT_Y +  0;	gWeaponStats[35].sValDx = 0;
				gWeaponStats[36].sX = SHIFT_X +  0;	gWeaponStats[36].sY = SHIFT_Y +  0;	gWeaponStats[36].sValDx = 0;
				gWeaponStats[37].sX = SHIFT_X +  0;	gWeaponStats[37].sY = SHIFT_Y +  0;	gWeaponStats[37].sValDx = 0;
				gWeaponStats[38].sX = SHIFT_X +  0;	gWeaponStats[38].sY = SHIFT_Y +  0;	gWeaponStats[38].sValDx = 0;
				gWeaponStats[39].sX = SHIFT_X +  0;	gWeaponStats[39].sY = SHIFT_Y +  0;	gWeaponStats[39].sValDx = 0;
				gWeaponStats[40].sX = SHIFT_X +  0;	gWeaponStats[40].sY = SHIFT_Y +  0;	gWeaponStats[40].sValDx = 0;
				gWeaponStats[41].sX = SHIFT_X +  0;	gWeaponStats[41].sY = SHIFT_Y +  0;	gWeaponStats[41].sValDx = 0;
				gWeaponStats[42].sX = SHIFT_X +  0;	gWeaponStats[42].sY = SHIFT_Y +  0;	gWeaponStats[42].sValDx = 0;
				gWeaponStats[43].sX = SHIFT_X +  0;	gWeaponStats[43].sY = SHIFT_Y +  0;	gWeaponStats[43].sValDx = 0;
				gWeaponStats[44].sX = SHIFT_X +  0;	gWeaponStats[44].sY = SHIFT_Y +  0;	gWeaponStats[44].sValDx = 0;
				gWeaponStats[45].sX = SHIFT_X +  0;	gWeaponStats[45].sY = SHIFT_Y +  0;	gWeaponStats[45].sValDx = 0;
				gWeaponStats[46].sX = SHIFT_X +  0;	gWeaponStats[46].sY = SHIFT_Y +  0;	gWeaponStats[46].sValDx = 0;

				gMoneyStats[0].sX = SHIFT_X +  51;	gMoneyStats[0].sY = SHIFT_Y +  97;		gMoneyStats[0].sValDx = 45;
				gMoneyStats[1].sX = SHIFT_X +  61;	gMoneyStats[1].sY = SHIFT_Y +  107;	gMoneyStats[1].sValDx = 75;
				gMoneyStats[2].sX = SHIFT_X +  51;	gMoneyStats[2].sY = SHIFT_Y +  125;	gMoneyStats[2].sValDx = 45;
				gMoneyStats[3].sX = SHIFT_X +  61;	gMoneyStats[3].sY = SHIFT_Y +  135;	gMoneyStats[3].sValDx = 70;
				gMoneyStats[4].sX = SHIFT_X +  0;	gMoneyStats[4].sY = SHIFT_Y +  0;		gMoneyStats[4].sValDx = 0;
				gMoneyStats[5].sX = SHIFT_X +  0;	gMoneyStats[5].sY = SHIFT_Y +  0;		gMoneyStats[5].sValDx = 0;

				gItemDescProsConsRects[0].iLeft = 14 + SHIFT_X;	gItemDescProsConsRects[0].iTop = 231 + SHIFT_Y;	gItemDescProsConsRects[0].iRight = 240 + SHIFT_X;	gItemDescProsConsRects[0].iBottom = 238 + SHIFT_Y;
				gItemDescProsConsRects[1].iLeft = 14 + SHIFT_X;	gItemDescProsConsRects[1].iTop = 239 + SHIFT_Y;	gItemDescProsConsRects[1].iRight = 240 + SHIFT_X;	gItemDescProsConsRects[1].iBottom = 246 + SHIFT_Y;
			}
			else
			{
				gWeaponStats[0].sX = SHIFT_X +  202;	gWeaponStats[0].sY = SHIFT_Y +  15;	gWeaponStats[0].sValDx = 83;	// 0) STATUS
				gWeaponStats[1].sX = SHIFT_X +  202;	gWeaponStats[1].sY = SHIFT_Y +  25;	gWeaponStats[1].sValDx = 83;	// 1) WEIGHT
				gWeaponStats[2].sX = SHIFT_X +  265;	gWeaponStats[2].sY = SHIFT_Y +  40;	gWeaponStats[2].sValDx = 20;	// 2) RANGE
				gWeaponStats[3].sX = SHIFT_X +  202;	gWeaponStats[3].sY = SHIFT_Y +  40;	gWeaponStats[3].sValDx = 32;	// 3) DAMAGE
				gWeaponStats[4].sX = SHIFT_X +  202;	gWeaponStats[4].sY = SHIFT_Y +  15;	gWeaponStats[4].sValDx = 83;	// 4) KEY
				gWeaponStats[5].sX = SHIFT_X +  202;	gWeaponStats[5].sY = SHIFT_Y +  50;	gWeaponStats[5].sValDx = 32;	// 5) AP
				gWeaponStats[6].sX = SHIFT_X +  265;	gWeaponStats[6].sY = SHIFT_Y +  50;	gWeaponStats[6].sValDx = 20;
				gWeaponStats[7].sX = SHIFT_X +  234;	gWeaponStats[7].sY = SHIFT_Y +  50;	gWeaponStats[7].sValDx = 0;		// 7) =
				gWeaponStats[8].sX = SHIFT_X +  290;	gWeaponStats[8].sY = SHIFT_Y +  50;	gWeaponStats[8].sValDx = 0;		// 8) =
				gWeaponStats[9].sX = SHIFT_X +  0;		gWeaponStats[9].sY = SHIFT_Y +  0;		gWeaponStats[9].sValDx = 0;
				gWeaponStats[10].sX = SHIFT_X +  0;	gWeaponStats[10].sY = SHIFT_Y +  0;	gWeaponStats[10].sValDx = 0;
				gWeaponStats[11].sX = SHIFT_X +  0;	gWeaponStats[11].sY = SHIFT_Y +  0;	gWeaponStats[11].sValDx = 0;
				gWeaponStats[12].sX = SHIFT_X +  0;	gWeaponStats[12].sY = SHIFT_Y +  0;	gWeaponStats[12].sValDx = 0;
				...
				gMoneyStats[0].sX = SHIFT_X +  202;	gMoneyStats[0].sY = SHIFT_Y +  14;		gMoneyStats[0].sValDx = 78;
				gMoneyStats[1].sX = SHIFT_X +  212;	gMoneyStats[1].sY = SHIFT_Y +  25;		gMoneyStats[1].sValDx = 78;
				gMoneyStats[2].sX = SHIFT_X +  203;	gMoneyStats[2].sY = SHIFT_Y +  40;		gMoneyStats[2].sValDx = 78;
				gMoneyStats[3].sX = SHIFT_X +  212;	gMoneyStats[3].sY = SHIFT_Y +  51;		gMoneyStats[3].sValDx = 78;
				gMoneyStats[4].sX = SHIFT_X +  0;		gMoneyStats[4].sY = SHIFT_Y +  0;		gMoneyStats[4].sValDx = 0;
				gMoneyStats[5].sX = SHIFT_X +  0;		gMoneyStats[5].sY = SHIFT_Y +  0;		gMoneyStats[5].sValDx = 0;

				gItemDescProsConsRects[0].iLeft = 7 + SHIFT_X;	gItemDescProsConsRects[0].iTop = 111 + SHIFT_Y;	gItemDescProsConsRects[0].iRight = 313 + SHIFT_X;	gItemDescProsConsRects[0].iBottom = 118 + SHIFT_Y;
				gItemDescProsConsRects[1].iLeft = 7 + SHIFT_X;	gItemDescProsConsRects[1].iTop = 119 + SHIFT_Y;	gItemDescProsConsRects[1].iRight = 313 + SHIFT_X;	gItemDescProsConsRects[1].iBottom = 126 + SHIFT_Y;
				
				//WarmSteel - moved this to somewhere else, but if it applies to this object
				if(UseNASDesc(pObject)){
					gItemDescProsConsRects[0].iLeft += 160;
					gItemDescProsConsRects[0].iRight += 160;
					gItemDescProsConsRects[1].iLeft += 160;
					gItemDescProsConsRects[1].iRight += 160;
					gItemDescProsConsRects[0].iTop += 57;
					gItemDescProsConsRects[0].iBottom += 57;
					gItemDescProsConsRects[1].iTop += 57;
					gItemDescProsConsRects[1].iBottom += 57;
				}
			}
		}
	} else {
	...
	if(gGameExternalOptions.fNewAttachmentSystem){
		...
		if(guiCurrentScreen ==MAP_SCREEN)	//Strategic
		{
			if(UsingEDBSystem() > 0)
			{
				...
				if(!UseNASDesc(pObject)){
					...
					BULLET_DRAW_X				= (112 + sX);
					BULLET_DRAW_Y				= (136 + sY);
					BULLET_SING_X				= (112 + sX);
					BULLET_SING_Y				= (148 + sY);
					BULLET_BURST_X			= (112 + sX);
					BULLET_BURST_Y			= (160 + sY);
					BULLET_AUTO_X			= (112 + sX);
					BULLET_AUTO_Y			= (172 + sY);
					BULLET_RELOAD_X			= (112 + sX);
					BULLET_RELOAD_Y			= (184 + sY);
					BULLET_MRELOAD_X			= (112 + sX);
					BULLET_MRELOAD_Y			= (196 + sY);
					BULLET_RANGE_X			= (47 + sX);
					BULLET_RANGE_Y			= (124 + sY);
					BULLET_DAMAGE_X			= (47 + sX);
					BULLET_DAMAGE_Y			= (136 + sY);
					BULLET_AUTOPEN_X			= (47 + sX);
					BULLET_AUTOPEN_Y			= (148 + sY);
					BULLET_AUTO5AP_X			= (47 + sX);
					BULLET_AUTO5AP_Y			= (160 + sY);
					BULLET_ACC_X			= (47 + sX);
					BULLET_ACC_Y			= (172 + sY);
					BULLET_RELIABILITY_X			= (47 + sX);
					BULLET_RELIABILITY_Y			= (184 + sY);
					BULLET_REPAIR_X			= (47 + sX);
					BULLET_REPAIR_Y			= (196 + sY);
					BULLET_LOUDNESS_X		= (174 + sX);
					BULLET_LOUDNESS_Y		= (136 + sY);
					BULLET_FLASH_X			= (198 + sX);
					BULLET_FLASH_Y			= (124 + sY);
					BULLET_TOHIT_X			= (174 + sX);
					BULLET_TOHIT_Y			= (148 + sY);
					BULLET_BESTLASERRANGE_X			= (174 + sX);
					BULLET_BESTLASERRANGE_Y			= (160 + sY);
					BULLET_AIMBONUS_X			= (174 + sX);
					BULLET_AIMBONUS_Y			= (172 + sY);
					BULLET_MINRANGEAIMBONUS_X	=	(174 + sX);
					BULLET_MINRANGEAIMBONUS_Y	=	(184 + sY);
					BULLET_BIPOD_X			= (174 + sX);
					BULLET_BIPOD_Y			= (196 + sY);

					// Icon Locations for AMMO stats
					BULLET_ARMORPEN_X		= (47 + sX);
					BULLET_ARMORPEN_Y		= (124 + sY);
					BULLET_TUMBLE_X		= (47 + sX);
					BULLET_TUMBLE_Y		= (136 + sY);
					BULLET_PREARMOR_X		= (47 + sX);
					BULLET_PREARMOR_Y		= (148 + sY);
					BULLET_TRACER_X		= (115 + sX);
					BULLET_TRACER_Y		= (124 + sY);
					BULLET_ANTITANK_X		= (140 + sX);
					BULLET_ANTITANK_Y		= (124 + sY);
					BULLET_LOCKBUSTER_X		= (115 + sX);
					BULLET_LOCKBUSTER_Y		= (148 + sY);
					BULLET_IGNOREARMOR_X		= (140 + sX);
					BULLET_IGNOREARMOR_Y		= (148 + sY);
					BULLET_ACIDIC_X		= (115 + sX);
					BULLET_ACIDIC_Y		= (172 + sY);
					BULLET_AMMORANGEBON_X		= (174 + sX);
					BULLET_AMMORANGEBON_Y		= (124 + sY);
					BULLET_AMMODAMAGEBON_X		= (174 + sX);
					BULLET_AMMODAMAGEBON_Y		= (136 + sY);
					BULLET_AMMOTOHITBON_X		= (174 + sX);
					BULLET_AMMOTOHITBON_Y		= (148 + sY);
					BULLET_AMMOAUTOBON_X		= (174 + sX);
					BULLET_AMMOAUTOBON_Y		= (160 + sY);
					BULLET_AMMOBURSTBON_X		= (174 + sX);
					BULLET_AMMOBURSTBON_Y		= (172 + sY);
					BULLET_AMMORELIABILITYBON_X		= (174 + sX);
					BULLET_AMMORELIABILITYBON_Y		= (184 + sY);
					BULLET_AMMONOISESUPP_X		= (174 + sX);
					BULLET_AMMONOISESUPP_Y		= (196 + sY);

					// Icon Locations for EXPLOSIVES stats
					BULLET_EXPLOSIVEDAMAGE_X	= (47 + sX);
					BULLET_EXPLOSIVEDAMAGE_Y	= (124 + sY);
					BULLET_EXPLOSIVESTUNDAMAGE_X	= (47 + sX);
					BULLET_EXPLOSIVESTUNDAMAGE_Y	= (136 + sY);
					BULLET_EXPLOSIVELOUDNESS_X	= (47 + sX);
					BULLET_EXPLOSIVELOUDNESS_Y	= (148 + sY);
					BULLET_EXPLOSIVEVOLATILITY_X	= (47 + sX);
					BULLET_EXPLOSIVEVOLATILITY_Y	= (160 + sY);
					BULLET_EXPLOSIVERADIUS_X	= (131 + sX);
					BULLET_EXPLOSIVERADIUS_Y	= (124 + sY);
					BULLET_EXPLOSIVESTARTRADIUS_X	= (113 + sX);
					BULLET_EXPLOSIVESTARTRADIUS_Y	= (124 + sY);
					BULLET_EXPLOSIVEARROW_X	= (131 + sX);
					BULLET_EXPLOSIVEARROW_Y	= (130 + sY);
					BULLET_EXPLOSIVEENDRADIUS_X	= (146 + sX);
					BULLET_EXPLOSIVEENDRADIUS_Y	= (124 + sY);
					BULLET_EXPLOSIVEDURATION_X	= (112 + sX);
					BULLET_EXPLOSIVEDURATION_Y	= (172 + sY);

					// Icon Locations for ARMOR stats
					BULLET_ARMOR_X	= (47 + sX);
					BULLET_ARMOR_Y	= (124 + sY);
					BULLET_ARMORCOVERAGE_X	= (47 + sX);
					BULLET_ARMORCOVERAGE_Y	= (136 + sY);
					BULLET_ARMORDEGRADE_X	= (47 + sX);
					BULLET_ARMORDEGRADE_Y	= (148 + sY);
					BULLET_ARMORAPBONUS_X	= (112 + sX);
					BULLET_ARMORAPBONUS_Y	= (124 + sY);
					BULLET_ARMORAIMBONUS_X	= (112 + sX);
					BULLET_ARMORAIMBONUS_Y	= (136 + sY);
					BULLET_ARMORWOODCAMO_X	= (112 + sX);
					BULLET_ARMORWOODCAMO_Y	= (148 + sY);
					BULLET_ARMORURBANCAMO_X	= (112 + sX);
					BULLET_ARMORURBANCAMO_Y	= (160 + sY);
					BULLET_ARMORDESERTCAMO_X	= (112 + sX);
					BULLET_ARMORDESERTCAMO_Y	= (172 + sY);
					BULLET_ARMORSNOWCAMO_X	= (112 + sX);
					BULLET_ARMORSNOWCAMO_Y	= (184 + sY);
					BULLET_ARMORSTEALTH_X	= (112 + sX);
					BULLET_ARMORSTEALTH_Y	= (196 + sY);
					BULLET_ARMORVISIONRANGEBONUS_X	= (174 + sX);
					BULLET_ARMORVISIONRANGEBONUS_Y	= (124 + sY);
					BULLET_ARMORDAYVISIONRANGEBONUS_X	= (175 + sX);
					BULLET_ARMORDAYVISIONRANGEBONUS_Y	= (136 + sY);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_X	= (175 + sX);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_Y	= (148 + sY);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_X	= (175 + sX);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_Y	= (160 + sY);
					BULLET_ARMORCAVEVISIONRANGEBONUS_X	= (175 + sX);
					BULLET_ARMORCAVEVISIONRANGEBONUS_Y	= (172 + sY);
					BULLET_ARMORPERCENTTUNNELVISION_X	= (175 + sX);
					BULLET_ARMORPERCENTTUNNELVISION_Y	= (184 + sY);
					BULLET_ARMORHEARINGRANGEBONUS_X	= (174 + sX);
					BULLET_ARMORHEARINGRANGEBONUS_Y	= (196 + sY);

					// Generic Icon Locations for MISC Item Stats
					BULLET_COL1ROW1_X = (47 + sX);
					BULLET_COL1ROW1_Y = (124 + sY);
					BULLET_COL1ROW2_X = (47 + sX);
					BULLET_COL1ROW2_Y = (136 + sY);
					BULLET_COL1ROW3_X = (47 + sX);
					BULLET_COL1ROW3_Y = (148 + sY);
					BULLET_COL1ROW4_X = (47 + sX);
					BULLET_COL1ROW4_Y = (160 + sY);
					BULLET_COL1ROW5_X = (47 + sX);
					BULLET_COL1ROW5_Y = (172 + sY);
					BULLET_COL1ROW6_X = (47 + sX);
					BULLET_COL1ROW6_Y = (184 + sY);
					BULLET_COL1ROW7_X = (47 + sX);
					BULLET_COL1ROW7_Y = (196 + sY);
					BULLET_COL2ROW1_X = (144 + sX);
					BULLET_COL2ROW1_Y = (124 + sY);
					BULLET_COL2ROW2_X = (144 + sX);
					BULLET_COL2ROW2_Y = (136 + sY);
					BULLET_COL2ROW3_X = (144 + sX);
					BULLET_COL2ROW3_Y = (148 + sY);
					BULLET_COL2ROW4_X = (144 + sX);
					BULLET_COL2ROW4_Y = (160 + sY);
					BULLET_COL2ROW5_X = (144 + sX);
					BULLET_COL2ROW5_Y = (172 + sY);
					BULLET_COL2ROW6_X = (144 + sX);
					BULLET_COL2ROW6_Y = (184 + sY);
					BULLET_COL2ROW7_X = (144 + sX);
					BULLET_COL2ROW7_Y = (196 + sY);
					...
					ITEMDESC_DESC_START_Y	= (230 + sY);
					ITEMDESC_PROS_START_X	= ( 23 + sX );
					ITEMDESC_PROS_START_Y	= (290 + sY);
			...
			else
			{
				...
				if(!UseNASDesc(pObject)){
					...
					BULLET_SING_X			= ( 77 + sX);
					BULLET_SING_Y			= (135 + sY);
					BULLET_BURST_X			= (117 + sX);
					BULLET_BURST_Y			= (135 + sY);
					ITEMDESC_CALIBER_X		= (105 + sX);
					ITEMDESC_CALIBER_Y		= ( 66 + sY);
					ITEMDESC_CALIBER_WIDTH	= 149;
					ITEMDESC_NAME_X			= (  7 + sX);
					...
					ITEMDESC_DESC_START_Y	= (170 + sY);
					ITEMDESC_PROS_START_X	= ( 23 + sX ); // Pros, Strategic
					ITEMDESC_PROS_START_Y	= (230 + sY);
		...
		else	//Tactical
		{
			if(UsingEDBSystem() == 1) // NIV EDB
			{
				...
				if(!UseNASDesc(pObject)){
					...
					BULLET_DRAW_X	=			(268 + sX);
					BULLET_DRAW_Y	=			(56 + sY);
					BULLET_SING_X	=			(268 + sX);
					BULLET_SING_Y	=			(68 + sY);
					BULLET_BURST_X	=		(268 + sX);
					BULLET_BURST_Y	=		(80 + sY);
					BULLET_AUTO_X	=		(268 + sX);
					BULLET_AUTO_Y	=		(92 + sY);
					BULLET_RELOAD_X	=		(268 + sX);
					BULLET_RELOAD_Y	=		(104 + sY);
					BULLET_MRELOAD_X	=		(268 + sX);
					BULLET_MRELOAD_Y	=		(116 + sY);
					BULLET_RANGE_X	=		(203 + sX);
					BULLET_RANGE_Y	=		(44 + sY);
					BULLET_DAMAGE_X		=	(203 + sX);
					BULLET_DAMAGE_Y		=	(56 + sY);
					BULLET_AUTOPEN_X	=		(203 + sX);
					BULLET_AUTOPEN_Y	=		(68 + sY);
					BULLET_AUTO5AP_X	=		(203 + sX);
					BULLET_AUTO5AP_Y	=		(80 + sY);
					BULLET_ACC_X		=	(203 + sX);
					BULLET_ACC_Y		=	(92 + sY);
					BULLET_RELIABILITY_X	=		(203 + sX);
					BULLET_RELIABILITY_Y	=		(104 + sY);
					BULLET_REPAIR_X		=	(203 + sX);
					BULLET_REPAIR_Y		=	(116 + sY);
					BULLET_FLASH_X		=	(226 + sX);	//291
					BULLET_FLASH_Y		=	(136 + sY);	//136
					BULLET_LOUDNESS_X	=	(203 + sX);	//268
					BULLET_LOUDNESS_Y	=	(160 + sY);	//159
					BULLET_TOHIT_X		=	(268 + sX);	//203
					BULLET_TOHIT_Y		=	(136 + sY);	//136
					BULLET_BESTLASERRANGE_X		=	(268 + sX);	//203
					BULLET_BESTLASERRANGE_Y		=	(148 + sY);	//148
					BULLET_AIMBONUS_X	=		(268 + sX);	//203
					BULLET_AIMBONUS_Y	=		(160 + sY);	//160
					BULLET_MINRANGEAIMBONUS_X	=	(268 + sX);	//203
					BULLET_MINRANGEAIMBONUS_Y	=	(172 + sY);	//172
					BULLET_BIPOD_X	=		(203 + sX);	//268
					BULLET_BIPOD_Y	=		(172 + sY);	//171

					// Icon Locations for AMMO stats
					BULLET_ARMORPEN_X	=	(203 + sX);
					BULLET_ARMORPEN_Y	=	(44 + sY);
					BULLET_TUMBLE_X	=	(203 + sX);
					BULLET_TUMBLE_Y	=	(56 + sY);
					BULLET_PREARMOR_X	=	(203 + sX);
					BULLET_PREARMOR_Y	=	(68 + sY);
					BULLET_TRACER_X	=	(271 + sX);
					BULLET_TRACER_Y	=	(44 + sY);
					BULLET_ANTITANK_X	=	(296 + sX);
					BULLET_ANTITANK_Y	=	(44 + sY);
					BULLET_LOCKBUSTER_X	=	(271 + sX);
					BULLET_LOCKBUSTER_Y	=	(68 + sY);
					BULLET_IGNOREARMOR_X	=	(296 + sX);
					BULLET_IGNOREARMOR_Y	=	(68 + sY);
					BULLET_ACIDIC_X	=	(271 + sX);
					BULLET_ACIDIC_Y	=	(92 + sY);
					BULLET_AMMORANGEBON_X	=	(203 + sX);
					BULLET_AMMORANGEBON_Y	=	(136 + sY);
					BULLET_AMMODAMAGEBON_X	=	(203 + sX);
					BULLET_AMMODAMAGEBON_Y	=	(160 + sY);
					BULLET_AMMOTOHITBON_X	=	(268 + sX);
					BULLET_AMMOTOHITBON_Y	=	(136 + sY);
					BULLET_AMMORELIABILITYBON_X	=	(203 + sX);
					BULLET_AMMORELIABILITYBON_Y	=	(172 + sY);
					BULLET_AMMOAUTOBON_X	=	(268 + sX);
					BULLET_AMMOAUTOBON_Y	=	(148 + sY);
					BULLET_AMMOBURSTBON_X	=	(268 + sX);
					BULLET_AMMOBURSTBON_Y	=	(160 + sY);
					BULLET_AMMONOISESUPP_X	=	(268 + sX);
					BULLET_AMMONOISESUPP_Y	=	(172 + sY);

					// Icon Locations for EXPLOSIVES stats
					BULLET_EXPLOSIVEDAMAGE_X	=	(203 + sX);
					BULLET_EXPLOSIVEDAMAGE_Y	=	(44 + sY);
					BULLET_EXPLOSIVESTUNDAMAGE_X	=	(203 + sX);
					BULLET_EXPLOSIVESTUNDAMAGE_Y	=	(56 + sY);
					BULLET_EXPLOSIVELOUDNESS_X	=	(203 + sX);
					BULLET_EXPLOSIVELOUDNESS_Y	=	(68 + sY);
					BULLET_EXPLOSIVEVOLATILITY_X	=	(203 + sX);
					BULLET_EXPLOSIVEVOLATILITY_Y	=	(80 + sY);
					BULLET_EXPLOSIVERADIUS_X	=	(288 + sX);
					BULLET_EXPLOSIVERADIUS_Y	=	(44 + sY);
					BULLET_EXPLOSIVESTARTRADIUS_X	=	(270 + sX);
					BULLET_EXPLOSIVESTARTRADIUS_Y	=	(44 + sY);
					BULLET_EXPLOSIVEARROW_X	=	(287 + sX);
					BULLET_EXPLOSIVEARROW_Y	=	(50 + sY);
					BULLET_EXPLOSIVEENDRADIUS_X	=	(303 + sX);
					BULLET_EXPLOSIVEENDRADIUS_Y	=	(44 + sY);
					BULLET_EXPLOSIVEDURATION_X	=	(268 + sX);
					BULLET_EXPLOSIVEDURATION_Y	=	(92 + sY);

					// Icon Locations for ARMOR stats
					BULLET_ARMOR_X	=	(203 + sX);
					BULLET_ARMOR_Y	=	(44 + sY);
					BULLET_ARMORCOVERAGE_X	=	(203 + sX);
					BULLET_ARMORCOVERAGE_Y	=	(56 + sY);
					BULLET_ARMORDEGRADE_X	=	(203 + sX);
					BULLET_ARMORDEGRADE_Y	=	(68 + sY);
					BULLET_ARMORAPBONUS_X	=	(268 + sX);
					BULLET_ARMORAPBONUS_Y	=	(44 + sY);
					BULLET_ARMORAIMBONUS_X	=	(268 + sX);
					BULLET_ARMORAIMBONUS_Y	=	(56 + sY);
					BULLET_ARMORWOODCAMO_X	=	(268 + sX);
					BULLET_ARMORWOODCAMO_Y	=	(68 + sY);
					BULLET_ARMORURBANCAMO_X	=	(268 + sX);
					BULLET_ARMORURBANCAMO_Y	=	(80 + sY);
					BULLET_ARMORDESERTCAMO_X	=	(268 + sX);
					BULLET_ARMORDESERTCAMO_Y	=	(92 + sY);
					BULLET_ARMORSNOWCAMO_X	=	(268 + sX);
					BULLET_ARMORSNOWCAMO_Y	=	(104 + sY);
					BULLET_ARMORSTEALTH_X	=	(268 + sX);
					BULLET_ARMORSTEALTH_Y	=	(116 + sY);
					BULLET_ARMORVISIONRANGEBONUS_X	=	(203 + sX);
					BULLET_ARMORVISIONRANGEBONUS_Y	=	(136 + sY);
					BULLET_ARMORDAYVISIONRANGEBONUS_X	=	(203 + sX);
					BULLET_ARMORDAYVISIONRANGEBONUS_Y	=	(148 + sY);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_X	=	(203 + sX);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_Y	=	(160 + sY);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_X	=	(203 + sX);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_Y	=	(172 + sY);
					BULLET_ARMORCAVEVISIONRANGEBONUS_X	=	(268 + sX);
					BULLET_ARMORCAVEVISIONRANGEBONUS_Y	=	(136 + sY);
					BULLET_ARMORPERCENTTUNNELVISION_X	=	(268 + sX);
					BULLET_ARMORPERCENTTUNNELVISION_Y	=	(148 + sY);
					BULLET_ARMORHEARINGRANGEBONUS_X	=	(268 + sX);
					BULLET_ARMORHEARINGRANGEBONUS_Y	=	(160 + sY);

					// Generic Icon Locations for MISC Item Stats
					BULLET_COL1ROW1_X =	(203 + sX);
					BULLET_COL1ROW1_Y =	(44 + sY);
					BULLET_COL1ROW2_X =	(203 + sX);
					BULLET_COL1ROW2_Y =	(56 + sY);
					BULLET_COL1ROW3_X =	(203 + sX);
					BULLET_COL1ROW3_Y =	(68 + sY);
					BULLET_COL1ROW4_X =	(203 + sX);
					BULLET_COL1ROW4_Y =	(80 + sY);
					BULLET_COL1ROW5_X =	(203 + sX);
					BULLET_COL1ROW5_Y =	(92 + sY);
					BULLET_COL1ROW6_X =	(203 + sX);
					BULLET_COL1ROW6_Y =	(104 + sY);
					BULLET_COL1ROW7_X =	(203 + sX);
					BULLET_COL1ROW7_Y =	(116 + sY);
					BULLET_COL1ROW8_X =	(203 + sX);
					BULLET_COL1ROW8_Y =	(128 + sY);
					BULLET_COL1ROW9_X =	(203 + sX);
					BULLET_COL1ROW9_Y =	(140 + sY);
					BULLET_COL1ROW10_X =	(203 + sX);
					BULLET_COL1ROW10_Y =	(152 + sY);
					BULLET_COL1ROW11_X =	(203 + sX);
					BULLET_COL1ROW11_Y =	(164 + sY);
					BULLET_COL1ROW12_X =	(203 + sX);
					BULLET_COL1ROW12_Y =	(176 + sY);
					...
					ITEMDESC_DESC_START_X	= (11 + sX);
					ITEMDESC_DESC_START_Y	= (94 + sY);
					ITEMDESC_PROS_START_X	= (11 + sX);
					ITEMDESC_PROS_START_Y	= (166 + sY);
					ITEMDESC_CONS_START_X	= (11 + sX);
			...
			else if(UsingEDBSystem() == 2) // OIV EDB
			{
				...
				if(!UseNASDesc(pObject)){
					...
					// Icon locations, Tactical
					BULLET_DRAW_X	=			(341 + sX);
					BULLET_DRAW_Y	=			(26 + sY);
					BULLET_SING_X	=			(341 + sX);
					BULLET_SING_Y	=			(38 + sY);
					BULLET_BURST_X	=		(341 + sX);
					BULLET_BURST_Y	=		(50 + sY);
					BULLET_AUTO_X	=		(341 + sX);
					BULLET_AUTO_Y	=		(62 + sY);
					BULLET_RELOAD_X	=		(341 + sX);
					BULLET_RELOAD_Y	=		(74 + sY);
					BULLET_MRELOAD_X	=		(341 + sX);
					BULLET_MRELOAD_Y	=		(86 + sY);
					BULLET_RANGE_X	=		(274 + sX);
					BULLET_RANGE_Y	=		(14 + sY);
					BULLET_DAMAGE_X		=	(274 + sX);
					BULLET_DAMAGE_Y		=	(26 + sY);
					BULLET_AUTOPEN_X	=		(274 + sX);
					BULLET_AUTOPEN_Y	=		(38 + sY);
					BULLET_AUTO5AP_X	=		(274 + sX);
					BULLET_AUTO5AP_Y	=		(50 + sY);
					BULLET_ACC_X		=	(274 + sX);
					BULLET_ACC_Y		=	(62 + sY);
					BULLET_RELIABILITY_X	=		(274 + sX);
					BULLET_RELIABILITY_Y	=		(74 + sY);
					BULLET_REPAIR_X		=	(274 + sX);
					BULLET_REPAIR_Y		=	(86 + sY);
					BULLET_FLASH_X		=	(431 + sX);	//291
					BULLET_FLASH_Y		=	(14 + sY);	//136
					BULLET_LOUDNESS_X	=	(408 + sX);	//268
					BULLET_LOUDNESS_Y	=	(26 + sY);	//159
					BULLET_TOHIT_X		=	(408 + sX);	//203
					BULLET_TOHIT_Y		=	(38 + sY);	//136
					BULLET_BESTLASERRANGE_X		=	(408 + sX);	//203
					BULLET_BESTLASERRANGE_Y		=	(50 + sY);	//148
					BULLET_AIMBONUS_X	=		(408 + sX);	//203
					BULLET_AIMBONUS_Y	=		(62 + sY);	//160
					BULLET_MINRANGEAIMBONUS_X	=	(408 + sX);	//203
					BULLET_MINRANGEAIMBONUS_Y	=	(74 + sY);	//172
					BULLET_BIPOD_X	=		(408 + sX);	//268
					BULLET_BIPOD_Y	=		(86 + sY);	//171

					// Icon Locations for AMMO stats
					BULLET_ARMORPEN_X	=	(274 + sX);
					BULLET_ARMORPEN_Y	=	(14 + sY);
					BULLET_TUMBLE_X	=	(274 + sX);
					BULLET_TUMBLE_Y	=	(26 + sY);
					BULLET_PREARMOR_X	=	(274 + sX);
					BULLET_PREARMOR_Y	=	(38 + sY);
					BULLET_TRACER_X	=	(344 + sX);
					BULLET_TRACER_Y	=	(14 + sY);
					BULLET_ANTITANK_X	=	(369 + sX);
					BULLET_ANTITANK_Y	=	(14 + sY);
					BULLET_LOCKBUSTER_X	=	(344 + sX);
					BULLET_LOCKBUSTER_Y	=	(38 + sY);
					BULLET_IGNOREARMOR_X	=	(369 + sX);
					BULLET_IGNOREARMOR_Y	=	(38 + sY);
					BULLET_ACIDIC_X	=	(344 + sX);
					BULLET_ACIDIC_Y	=	(62 + sY);
					BULLET_AMMORANGEBON_X	=	(408 + sX);
					BULLET_AMMORANGEBON_Y	=	(14 + sY);
					BULLET_AMMODAMAGEBON_X	=	(408 + sX);
					BULLET_AMMODAMAGEBON_Y	=	(26 + sY);
					BULLET_AMMOTOHITBON_X	=	(408 + sX);
					BULLET_AMMOTOHITBON_Y	=	(38 + sY);
					BULLET_AMMOAUTOBON_X	=	(408 + sX);
					BULLET_AMMOAUTOBON_Y	=	(50 + sY);
					BULLET_AMMOBURSTBON_X	=	(408 + sX);
					BULLET_AMMOBURSTBON_Y	=	(62 + sY);
					BULLET_AMMORELIABILITYBON_X	=	(408 + sX);
					BULLET_AMMORELIABILITYBON_Y	=	(74 + sY);
					BULLET_AMMONOISESUPP_X	=	(408 + sX);
					BULLET_AMMONOISESUPP_Y	=	(86 + sY);

					// Icon Locations for EXPLOSIVES stats
					BULLET_EXPLOSIVEDAMAGE_X	=	(274 + sX);
					BULLET_EXPLOSIVEDAMAGE_Y	=	(14 + sY);
					BULLET_EXPLOSIVESTUNDAMAGE_X	=	(274 + sX);
					BULLET_EXPLOSIVESTUNDAMAGE_Y	=	(26 + sY);
					BULLET_EXPLOSIVELOUDNESS_X	=	(274 + sX);
					BULLET_EXPLOSIVELOUDNESS_Y	=	(38 + sY);
					BULLET_EXPLOSIVEVOLATILITY_X	=	(274 + sX);
					BULLET_EXPLOSIVEVOLATILITY_Y	=	(50 + sY);
					BULLET_EXPLOSIVERADIUS_X	=	(359 + sX);
					BULLET_EXPLOSIVERADIUS_Y	=	(14 + sY);
					BULLET_EXPLOSIVESTARTRADIUS_X	=	(343 + sX);
					BULLET_EXPLOSIVESTARTRADIUS_Y	=	(14 + sY);
					BULLET_EXPLOSIVEARROW_X	=	(362 + sX);
					BULLET_EXPLOSIVEARROW_Y	=	(20 + sY);
					BULLET_EXPLOSIVEENDRADIUS_X	=	(378 + sX);
					BULLET_EXPLOSIVEENDRADIUS_Y	=	(14 + sY);
					BULLET_EXPLOSIVEDURATION_X	=	(341 + sX);
					BULLET_EXPLOSIVEDURATION_Y	=	(62 + sY);

					// Icon Locations for ARMOR stats
					BULLET_ARMOR_X	=	(274 + sX);
					BULLET_ARMOR_Y	=	(14 + sY);
					BULLET_ARMORCOVERAGE_X	=	(274 + sX);
					BULLET_ARMORCOVERAGE_Y	=	(26 + sY);
					BULLET_ARMORDEGRADE_X	=	(274 + sX);
					BULLET_ARMORDEGRADE_Y	=	(38 + sY);
					BULLET_ARMORAPBONUS_X	=	(341 + sX);
					BULLET_ARMORAPBONUS_Y	=	(14 + sY);
					BULLET_ARMORAIMBONUS_X	=	(341 + sX);
					BULLET_ARMORAIMBONUS_Y	=	(26 + sY);
					BULLET_ARMORWOODCAMO_X	=	(341 + sX);
					BULLET_ARMORWOODCAMO_Y	=	(38 + sY);
					BULLET_ARMORURBANCAMO_X	=	(341 + sX);
					BULLET_ARMORURBANCAMO_Y	=	(50 + sY);
					BULLET_ARMORDESERTCAMO_X	=	(341 + sX);
					BULLET_ARMORDESERTCAMO_Y	=	(62 + sY);
					BULLET_ARMORSNOWCAMO_X	=	(341 + sX);
					BULLET_ARMORSNOWCAMO_Y	=	(74 + sY);
					BULLET_ARMORSTEALTH_X	=	(341 + sX);
					BULLET_ARMORSTEALTH_Y	=	(86 + sY);
					BULLET_ARMORVISIONRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORVISIONRANGEBONUS_Y	=	(14 + sY);
					BULLET_ARMORDAYVISIONRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORDAYVISIONRANGEBONUS_Y	=	(26 + sY);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORNIGHTVISIONRANGEBONUS_Y	=	(38 + sY);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORBRIGHTLIGHTVISIONRANGEBONUS_Y	=	(50 + sY);
					BULLET_ARMORCAVEVISIONRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORCAVEVISIONRANGEBONUS_Y	=	(68 + sY);
					BULLET_ARMORPERCENTTUNNELVISION_X	=	(408 + sX);
					BULLET_ARMORPERCENTTUNNELVISION_Y	=	(72 + sY);
					BULLET_ARMORHEARINGRANGEBONUS_X	=	(408 + sX);
					BULLET_ARMORHEARINGRANGEBONUS_Y	=	(86 + sY);

					// Generic Icon Locations for MISC Item Stats
					BULLET_COL1ROW1_X =	(274 + sX);
					BULLET_COL1ROW1_Y =	(14 + sY);
					BULLET_COL1ROW2_X =	(274 + sX);
					BULLET_COL1ROW2_Y =	(26 + sY);
					BULLET_COL1ROW3_X =	(274 + sX);
					BULLET_COL1ROW3_Y =	(38 + sY);
					BULLET_COL1ROW4_X =	(274 + sX);
					BULLET_COL1ROW4_Y =	(50 + sY);
					BULLET_COL1ROW5_X =	(274 + sX);
					BULLET_COL1ROW5_Y =	(62 + sY);
					BULLET_COL1ROW6_X =	(274 + sX);
					BULLET_COL1ROW6_Y =	(74 + sY);
					BULLET_COL1ROW7_X =	(274 + sX);
					BULLET_COL1ROW7_Y =	(86 + sY);
					BULLET_COL1ROW8_X =	(375 + sX);
					BULLET_COL1ROW8_Y =	(14 + sY);
					BULLET_COL1ROW9_X =	(375 + sX);
					BULLET_COL1ROW9_Y =	(26 + sY);
					BULLET_COL1ROW10_X =	(375 + sX);
					BULLET_COL1ROW10_Y =	(38 + sY);
					BULLET_COL1ROW11_X =	(375 + sX);
					BULLET_COL1ROW11_Y =	(50 + sY);
					BULLET_COL1ROW12_X =	(375 + sX);
					BULLET_COL1ROW12_Y =	(62 + sY);
					ITEMDESC_CALIBER_X		= ( 53 + sX); // Caliber text moved two lines below item name, and pulled closer
					ITEMDESC_CALIBER_Y		= ( 78 + sY);
					...
					ITEMDESC_ITEM_X			= (  15 + sX);
					ITEMDESC_ITEM_Y			= ( 8 + sY);
					ITEMDESC_DESC_START_X	= (11 + sX); // Description text Y moved downwards one line.
					ITEMDESC_DESC_START_Y	= (102 + sY);
					ITEMDESC_PROS_START_X	= (438 + sX ); // Pros and cons moved to the extreme right of the text box. They
					ITEMDESC_PROS_START_Y	= (106 + sY);  // now show just the words "PROS" and "CONS", and have a tooltip
					ITEMDESC_CONS_START_X	= (438 + sX ); // region over them for expanded text. :D
					ITEMDESC_CONS_START_Y	= (118 + sY);
				...
				if(!UseNASDesc(pObject)){
					...
					// Icon locations, TACTICAL
					BULLET_SING_X	=			(222 + sX);
					BULLET_SING_Y	=			(49 + sY);
					BULLET_BURST_X	=		(263 + sX);
					BULLET_BURST_Y	=		(49 + sY);
					...
					ITEMDESC_ITEM_X			= ( 15 + sX);
					ITEMDESC_ITEM_Y			= ( 8 + sY);
					ITEMDESC_DESC_START_X	= (10 + sX);// Item Desc Box offset, tactical, money or LBE
					ITEMDESC_DESC_START_Y	= (81 + sY);
					ITEMDESC_PROS_START_X	= (11 + sX);// Pros, tactical, money or LBE
					ITEMDESC_PROS_START_Y	= (110 + sY);
					ITEMDESC_CONS_START_X	= (11 + sX);// Cons, Tactical, money or LBE
					ITEMDESC_CONS_START_Y	= (120 + sY);
					ITEMDESC_DESC_WIDTH		= 230;//155; // Text box width, Tactical, money or LBE
					ITEMDESC_ITEM_STATUS_X	= (  6 + sX );
					ITEMDESC_ITEM_STATUS_Y	= ( 53 + sY );
					ITEMDESC_ITEM_STATUS_HEIGHT	= 40;
					ITEMDESC_AMMO_X = 15 + sX;
					...
					ITEMDESC_PROS_START_X	= (175 + sX);// Pros, tactical
					ITEMDESC_PROS_START_Y	= (167 + sY);
		...
		else	//Tactical
		{
			if(UsingEDBSystem() == 1) // NIV EDB
			{
				...
				ITEMDESC_DESC_START_Y	= ( 94 + sY);
				ITEMDESC_PROS_START_X	= ( 11 + sX );
				ITEMDESC_PROS_START_Y	= (168 + sY);
				ITEMDESC_CONS_START_X	= ( 11 + sX );
				ITEMDESC_CONS_START_Y	= (178 + sY);
				ITEMDESC_DESC_WIDTH		=	180;
				ITEMDESC_ITEM_STATUS_X	= (  6 + sX );
			...
			else
			{
				...
				ITEMDESC_ITEM_X			= (  8 + sX);
				ITEMDESC_ITEM_Y			= ( 11 + sY);
				ITEMDESC_DESC_START_X	= (11 + sX); // Item Desc Box offset, tactical
				ITEMDESC_DESC_START_Y	= (80 + sY);
				ITEMDESC_PROS_START_X	= ( 11 + sX ); // Pros, tactical
				ITEMDESC_PROS_START_Y	= (110 + sY);
				ITEMDESC_CONS_START_X	= ( 11 + sX ); // Cons, Tactical
				ITEMDESC_CONS_START_Y	= (120 + sY);
...
void InternalInitEDBTooltipRegion( OBJECTTYPE * gpItemDescObject, UINT32 guiCurrentItemDescriptionScreen )
{
	...
	if ( guiCurrentItemDescriptionScreen == MAP_SCREEN )
	{
		...
		else if ( Item[ gpItemDescObject->usItem ].usItemClass & IC_AMMO )
		{
			...
			// RELIABILITY BONUS
			if ( GetReliability( gpItemDescObject ) != 0 )
			{
				MSYS_EnableRegion( &gStatsFasthelpRegions[ 13 ] );
			}
		...
		else
		{
			...
			if ( GetReliability( gpItemDescObject ) != 0 && cnt<=threshold )
			{
...
void DrawWeaponValues( OBJECTTYPE * gpItemDescObject )
{
	...
	/* //WarmSteel - Replaced by the following function.
	...
	*/
	...
	INT16 iReliabilityValue = GetReliability( gpItemDescObject );
...
void DrawArmorValues( OBJECTTYPE * gpItemDescObject )
{
	...
	{
		if (Item[ iter->usItem ].usItemClass == IC_ARMOUR && iter->exists())
		{
...
void DrawMiscValues( OBJECTTYPE * gpItemDescObject )
{
	...
	if ( GetReliability( gpItemDescObject ) != 0 && cnt<=27 )
	{
		// equals
		SetFontForeground( 6 );
		mprintf( gMiscItemStatsEDB[ cnt ].sX + gsInvDescX, gMiscItemStatsEDB[ cnt ].sY + gsInvDescY, L"%s", gWeaponStatsDesc[ 8 ] );
		...
		iReliabilityModifier = GetReliability( gpItemDescObject );
