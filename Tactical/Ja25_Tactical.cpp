...
void InitGridNoUB()
{
	SWITCHINMORRISAREA_GRIDNO = gGameLegionOptions.SWITCHINMORRISAREA_GRIDNOa; //= 15231;
	SWITCHTOLAUNCHMISSLES_GRIDNO1 = gGameLegionOptions.SWITCHTOLAUNCHMISSLES_GRIDNO1a; //= 14268;
	SWITCHTOLAUNCHMISSLES_GRIDNO2 = gGameLegionOptions.SWITCHTOLAUNCHMISSLES_GRIDNO2a; //= 15708;
	RADIOLOCATORS_GRIDNO1 = gGameLegionOptions.RADIOLOCATORS_GRIDNO1a; //= 15070;
	RADIOLOCATORS_GRIDNO2 = gGameLegionOptions.RADIOLOCATORS_GRIDNO2a; //= 14744;
	POWERGENSECTOR_GRIDNO1 = gGameLegionOptions.POWERGENSECTOR_GRIDNO1a; //= 15100;
	POWERGENSECTOR_GRIDNO2 = gGameLegionOptions.POWERGENSECTOR_GRIDNO2a; //= 12220;
	POWERGENSECTOR_GRIDNO3 = gGameLegionOptions.POWERGENSECTOR_GRIDNO3a; //= 14155;
	POWERGENSECTOR_GRIDNO4 = gGameLegionOptions.POWERGENSECTOR_GRIDNO4a; //= 13980;
	POWERGENSECTOREXITGRID_GRIDNO1 = gGameLegionOptions.POWERGENSECTOREXITGRID_GRIDNO1a; // = 19749;
	POWERGENFANSOUND_GRIDNO1 = gGameLegionOptions.POWERGENFANSOUND_GRIDNO1a; //= 10979;
	POWERGENFANSOUND_GRIDNO2 = gGameLegionOptions.POWERGENFANSOUND_GRIDNO2a; //= 19749;
	STARTFANBACKUPAGAIN_GRIDNO = gGameLegionOptions.STARTFANBACKUPAGAIN_GRIDNOa; //= 10980;
	STOPPOWERGENFAN_GRIDNO = gGameLegionOptions.STOPPOWERGENFAN_GRIDNOa; //= 10980;
}
