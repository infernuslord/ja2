...
//return(	GetAPsToChangeStance( pSoldier, ANIM_STAND ) + APBPConstants[AP_JUMPWINDOW] );
	...
	{
		// OK, add aps to goto stand stance...
		return(( APBPConstants[AP_JUMPWINDOW] + GetAPsToChangeStance( pSoldier, ANIM_STAND ) ) );
	}
	else
	{
		// Add aps to goto crouch
		return(( APBPConstants[AP_JUMPWINDOW] + GetAPsToChangeStance( pSoldier, ANIM_CROUCH ) ) );
	}
