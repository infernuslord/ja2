...
{
 L"Przełącz wyświetlanie graczy", //0
 L"Przełącz wyświetlanie wrogów",
 L"Przełącz wyświetlanie zwierząt",
 L"Przełącz wyświetlanie rebeliantów",
 L"Przełącz wyświetlanie cywili",
...
{
	//L"Odleg?o?栯d celu (w polach): %d, Jasno?栽 %d/%d",
	L"Nadajnik został podłączony do twojego laptopa.",
	L"Nie możesz zatrudnić",
	L"Na określony czas, poniższe honorarium pokryje koszt całej misji razem z wyposażeniem zamieszonym poniżej.",
	L"Zatrudnij %s(a) już teraz i weź udział w naszej promocji 'jedno honorarium pokrywa wszystko'.  Ponadto w tej niewiarygodnej ofercie cały ekwipunek najemnika dostaniesz za darmo.",
	L"Honorarium",
	L"Kto? jest w sektorze...",
	//L"Zasiꧠbroni (w polach): %d, Szansa na trafienie: %d procent",
	L"Pokaż os?on",
	L"Zasięg wzroku",
	L"Nowi rekruci nie mogą tam przybyć",
	L"Dop?tw?aptop bꤺie bez nadajnika, nie bꤺiesz m?zatrudnia栮owych cz?onk?espo?u.  Mo?liwe, ?e to odpowiedni moment ?eby odczyta栺apisany stan gry lub zacz?栧ra栯d nowa!",
	L"%s s?yszy d?wiꫠzgniatanego metalu dochodz?cy spod cia?a Jerrego.  To niestety zabrzmia?o jak d?wiꫠzgniatanej anteny od twojego laptopa.",  //the %s is the name of a merc.  @@@  Modified
	L"Po zapoznaniu si꠺ tre?ci? notki zostawionej przez wice-dow? Morrisa, %s wyczuwa nadarzaj?c? si꠯kazjꮠNotka zawiera koordynaty dotycz?ce odpalenia pocisk?a r? miasta w Arluco. Znajduj? si꠮a niej tak?e koordynaty wyrzutni pocisk?",
	L"Spostrzeg?szy panel sterowania, %s zauwa?a, ?e liczby mo?na odwr? tak, ?eby pociski zniszczy?y sam? wyrzutniꮠ%s musi znale?栤rog꠵cieczki. Najszybszym rozwi?zaniem wydaje siꠢy样inda...",
	L"To jest tryb CZ?OWIEK ZE STALI i nie mo?esz zapisywa栧ry gdy wr?est w sektorze.",	//	@@@  new text
	L"(Nie mo?na zapisywa栧ry podczas walki)", //@@@@ new text
	L"Kampania ma wi꣥j ni? 30 postaci.",							// @@@ new text
	L"Nie mo?na odnale?栫ampanii.",																	// @@@ new text
	L"Kampania: Standardowa ( %S )",																							// @@@ new text
	L"Kampania: %S",																													// @@@ new text
	L"Wybra?e? kampaniꠥS. Ta kampania zosta?a stworzona przez fan?ry. Czy jeste? pewien, ?e chcesz w ni? zagra",			// @@@ new text
	L"?eby u?y栥dytora powiniene? wcze?niej wybra栫ampani꠩nn? ni? standardowa.",		///@@new
};
