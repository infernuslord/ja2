...
STR16 pFilesSenderList[] =
{
	...
	L"Mission briefing", //mission briefing by Jazz
};
*/
...
STR16	gzMPHScreenText[] =
{
	...
	L"Team Deathmatch",
	L"Co-operative",
	L"Maksymalna liczba graczy",
	L"Rozmiar druøyny",
	L"WybÛr najemnikÛw",
	L"Losowi najemnicy",
	L"WynajÍci przez gracza",
	L"Poczπtkowy stan gotÛwki",
	L"Moøna wynajmowaÊ takich samych najemnikÛw",
	L"Report Hired Mercs",
	L"Dozwolone korzystanie z Bobby Rays",
	L"Losowa pozycja startowa",
	L"Musisz podaÊ nazwÍ serwera",
	L"Maksymalna liczba graczy musi byÊ pomiÍdzy 2 i 4",
	L"Rozmiar druøyny musi byÊ pomiÍdzy 1 i 6",
	L"Pora dnia",
	L"Pora dnia musi byÊ w formacie 24-godzinnym (GG:MM)",
	L"Poczπtkowy stan gotÛwki musi byÊ podany w dolarach (bez centÛw)" ,
	L"Mnoønik obraøeÒ",
	L"Mnoønik obraøeÒ musi byÊ liczbπ pomiÍdzy 0 i 5",
	L"Mnoønik czasu",
	L"Mnoønik czasu musi byÊ liczbπ pomiÍdzy 0 (tury nielimitowane czasowo) i 200 (krÛtki czas na turÍ)",
	L"UmoøliwiÊ wystÍpowanie cywili w trybie CO-OP",
	L"Uøywaj nowego trybu wyposaøenia (NTW)",
	L"Katalog synchronizacji klientÛw rozgrywki wieloosobowej",
	L"Katalog synchronizacji gry wieloosobowej",
	L"Musisz wskazaÊ katalog wymiany plikÛw.",
	L"(Uøyj '/' zamiast '\\' jako separatora.)",
	L"Podany katalog synchronizacji nie istnieje.",
};
...
STR16 pMapScreenJustStartedHelpText[] =
{
	...
	L"Jeúli chcesz juø udaÊ siÍ do Tracona, kliknij przycisk kompresji czasu, w prawym dolnym rogu ekranu.", // to inform the player to hit time compression to get the game underway
};
...
STR16 sgAttributeSelectionText[] = 
{
	...
	//L"ProszÍ, dobierz punkty tak, by najlepiej opisywa≥y twoje atrybuty.",
};
...
{
	L"Zapytaj o naszπ specjalnπ ofertÍ!",
...
{
	//L"Odleg≥oúÊ od celu (w polach): %d, JasnoúÊ = %d/%d",
	L"Nadajnik zosta≥ pod≥πczony do twojego laptopa.",
	L"Nie moøesz zatrudniÊ %s(a)",
	L"Na okreúlony czas, poniøsze honorarium pokryje koszt ca≥ej misji razem z wyposaøeniem zamieszonym poniøej.",
	L"Zatrudnij %s(a) juø teraz i weü udzia≥ naszej promocji 'jedno honorarium pokrywa wszystko'.  Ponadto w tej niewiarygodnej ofercie ca≥y ekwipunek najemnika dostaniesz za darmo.",
	L"Honorarium",
	L"Ktoú jest w sektorze...",
	//L"ZasiÍg broni (w polach): %d, Szansa na trafienie: %d procent",
	L"Pokaø os≥onÍ",
	L"ZasiÍg wzroku",
	L"Nowi rekruci nie mogπ tam przybyÊ.",
	L"DopÛki twÛj laprop bÍdzie bez nadajnika, nie bÍdziesz mÛg≥ zatrudniaÊ nowych cz≥onkÛw zespo≥u.  Moøliwe, øe to odpowiedni moment øeby odczytaÊ zapisany stan gry lub zaczπÊ graÊ od nowa!",
	L"%s s≥yszy düwiÍk zgniatanego metalu dochodzπcy spod cia≥a Jerrego.  To niestety zabrzmia≥o jak düwiÍk zgniatanej anteny od twojego laptopa.",  //the %s is the name of a merc.  @@@  Modified
	L"Po zapoznaniu siÍ z treúciπ notki zostawionej przez wice-dowÛdcÍ Morrisa, %s wyczuwa nadarzajπcπ siÍ okazjÍ. Notka zawiera koordynaty dotyczπce odpalenia pociskÛw na rÛøne miasta w Arluco. Znajdujπ siÍ na niej takøe koordynaty wyrzutni pociskÛw.",
	L"Spostrzeg≥szy panel sterowania, %s zauwaøa, øe liczby moøna odwrÛciÊ tak, øeby pociski zniszczy≥y samπ wyrzutniÍ. %s musi znaleüÊ drogÍ ucieczki. Najszybszym rozwiπzaniem wydaje siÍ byÊ winda...",
	L"To jest tryb CZ£OWIEK ZE STALI i nie moøesz zapisywaÊ gry gdy wrÛg jest w sektorze.",	//	@@@  new text
	L"(Nie moøna zapisywaÊ gry podczas walki)", //@@@@ new text
	L"Kampania ma wiÍcej niø 30 postaci.",							// @@@ new text
	L"Nie moøna odnaleüÊ kampanii.",																	// @@@ new text
	L"Kampania: Standardowa ( %S )",																							// @@@ new text
	L"Kampania: %S",																													// @@@ new text
	L"Wybra≥eú kampaniÍ %S. Ta kampania zosta≥a stworzona przez fanÛw gry. Czy jesteú pewien, øe chcesz w niπ zagraÊ?",			// @@@ new text
	L"Øeby uøyÊ edytora powinieneú wczeúniej wybraÊ kampaniÍ innπ niø standardowa.",		///@@new
};
