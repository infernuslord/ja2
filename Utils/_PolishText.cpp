...
STR16 pUpdateMercsInfoText[] = 
{
	...
	L"Wszystkie informacje (statystyki, itd.) bÍdπ pobrane z pliku Prof.dat lub MercProfiles25.xml. ",
...
STR16 pMessageStrings[] =
{
	...
	L"Utworzono zapis gry o nazwie SaveGame249.sav. W razie potrzeby zmieÒ jego nazwÍ na SaveGame01..10. Wtedy bÍdzie moøna go odczytaÊ ze standardowego okna odczytu gry.",
	L"%s wypi≥(a) trochÍ - %s",
...
STR16	zNewTacticalMessages[]=
{
	...
	L"DopÛki twÛj laptop bÍdzie bez nadajnika, nie bÍdziesz mÛg≥ zatrudniaÊ nowych cz≥onkÛw zespo≥u.  Moøliwe, øe to odpowiedni moment øeby odczytaÊ zapisany stan gry lub zaczπÊ graÊ od nowa!",
