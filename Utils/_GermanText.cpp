...
STR16 pMessageStrings[] =
{
	...
	L"Dieser Platz ist reserviert für Spielstände am Ende eines Spieler Zuges. Dies kann ein/ausgeschaltet werden in den Optionen.", //99	// The text, when the user clicks on the save screen on an auto save
	// Mouse tooltips
	L"QuickSave.sav",	// 100
...
STR16	zNewTacticalMessages[]=
{
	...
	L"Das obenstehende Honorar deckt f?r einen begrenzten Zeitraum die Kosten der Gesamtmission, und schlieߴ untenstehendes Equipment mit ein.",
	L"Engagieren Sie %s jetzt und nutzen Sie den Vorteil unseres beispiellosen 'Ein Betrag f?r alles'-Honorars. Das pers?che Equipment des S?ers ist gratis in diesem Preis mit inbegriffen.",
	L"Honorar",
	L"Da ist noch jemand im Sektor...",
	//L"Waffen-Rchwt.: %d Felder, Trefferwahrsch.: %d Prozent",
	L"Deckung anzeigen",
	L"Sichtfeld",
	L"Neue Rekruten k?n dort nicht hinkommen.",
	L"Da Ihr Laptop keinen Transmitter besitzt, k?n Sie keine neuen Teammitglieder anheuern. Vielleicht ist dies eine guter Zeitpunkt, ein gespeichertes  Spiel zu laden oder ein neues zu starten!",
	L"%s h?das Ger䵳ch knirschenden Metalls unter Jerry hervordringen. Es klingt gr䳳lich - die Antenne ihres Laptop-Computers ist  zerst?",  //the %s is the name of a merc.  @@@  Modified
	L"Nach Ansehen des Hinweises, den Commander Morris hinterlie߬ erkennt %s eine einmalige Gelegenheit. Der Hinweis enth䬴 Koordinaten f?r den Start von Raketen gegen verschiedene St䤴e in Tracona. Aber er enth䬴 auch die Koordinaten des Startpunktes - der Raketenanlage.",
	L"Das Kontroll-Board studierend, entdeckt %s, dass die Zahlen umgedreht werden k?en, so dass die Raketen diese Anlage selbst zerst?. %s muss nun einen Fluchtweg finden. Der Aufzug scheint die schnellstm?che Route zu bieten...",         //!!! The original reads:	L"Noticing the control panel %s, figures the numbers can be reversed..." That sounds odd for me, but I think the comma is placed one word too late... (correct?)
	L"Dies ist ein IRON MAN-Spiel, und es kann nicht gespeichert werden, wenn sich Gegner in der N䨥 befinden.",		
	L"(Kann w䨲end Kampf nicht speichern)", 
	L"Der Name der aktuellen Kampagne enth䬴 mehr als 30 Buchstaben.",						
	L"Die aktuelle Kampagne kann nicht gefunden werden.",																	
	L"Kampagne: Standard ( %S )",																							
	L"Kampagne: %S",																													
	L"Sie haben die Kampagne %S gew䨬t. Diese ist eine vom Spieler modifizierte Version der Originalkampagne von JA2UB. M?en Sie die Kampagne %S spielen?",			
	L"Um den Editor zu benutzen, m?ssen Sie eine andere als die Standardkampgane ausw䨬en.",		
};
#endif //GERMAN
