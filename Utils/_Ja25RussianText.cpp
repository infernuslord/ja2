// WANNE: Disabled this, because if we build a Release Version in VS 2005 the progress bar when loading the sector is not moving in Russian Version!
// In VS 2010 it works, but anyway I disabled it for now.
