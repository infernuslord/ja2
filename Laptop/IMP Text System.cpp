...
//			PrintIMPPersonalityQuizQuestionAndAnsers( );
		...
		case( IMP_ATTRIBUTE_ENTRANCE ):
			if ( gGameOptions.fNewTraitSystem )
			{
				...
				//DisplayWrappedString( LAPTOP_SCREEN_UL_X + 130, LAPTOP_SCREEN_WEB_UL_Y + 210,  ( 456 - 200 ), 2, FONT12ARIAL, FONT_WHITE, sgAttributeSelectionText[ 7 ],FONT_BLACK,FALSE,CENTER_JUSTIFIED);
